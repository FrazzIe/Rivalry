		...
		if PersonalVehicles[Index].Insurance == true and PersonalVehicles[Index].State == "Missing" then
			...
			Item.Activated = function(ParentMenu, SelectedItem)
				if SelectedItem:Enabled() then
					...
					Utilities.DestroyVehicle(PersonalVehicles[Index].Handle)
	...
	while true do
		...
		if Player.Ready then
			...
			for Index = 1, #Config.Insurance do
				...
				if Distance < 20 then
					Utilities.RenderMarker(25, Config.Insurance[Index].Coordinates.x, Config.Insurance[Index].Coordinates.y, Config.Insurance[Index].Coordinates.z, 2.0, 2.0, 2.5, 255, 255, 0, 255)
			...
			for Index = 1, #Config.Selling do
				...
				if Distance < 20 then
					Utilities.RenderMarker(25, Config.Selling[Index].Coordinates.x, Config.Selling[Index].Coordinates.y, Config.Selling[Index].Coordinates.z, 2.0, 2.0, 2.5, 255, 255, 0, 255)
					
					if Distance < 2 then
						Utilities.DisplayHelpText("Press ~INPUT_CONTEXT~ to sell your vehicle!")
