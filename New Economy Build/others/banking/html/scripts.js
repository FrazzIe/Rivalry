...
$(document).ready(function(){
  ...
  document.onkeyup = function (data) {
    if (data.which == 27 ) {
      $.post('http://others/close', JSON.stringify({}));
    }
  };
  // Handle Button Presses
  $(".btnWithdraw").click(function(){
      $.post('http://others/withdraw', JSON.stringify({}));
  });
  $(".btnDeposit").click(function(){
      $.post('http://others/deposit', JSON.stringify({}));
  });
  $(".btnTransfer").click(function(){
      $.post('http://others/transfer', JSON.stringify({}));
  });
  $(".btnBalance").click(function(){
      $.post('http://others/balance', JSON.stringify({}));
  });
  $('.btnQuick').click($.throttle( 2000, true, function(e){
    $.post('http://others/quickCash', JSON.stringify({}));
  }));
  ...
  $("#withdraw-form").submit(function(e) {
      e.preventDefault();
      $.post('http://others/withdrawSubmit', JSON.stringify({
  ...
  $("#deposit-form").submit(function(e) {
      e.preventDefault();
      $.post('http://others/depositSubmit', JSON.stringify({
  ...
  $("#transfer-form").submit(function(e) {
      e.preventDefault();
      $.post('http://others/transferSubmit', JSON.stringify({
