...
AddEventHandler("dispatch:ten-thirtyone", function(coords, street_name, model, plate, color)
	for id, dept in pairs(emergency_users) do
		if dept ~= nil and dept ~= "paramedic" then
			TriggerClientEvent("chatMessage", id, "10-31", {255, 0, 0}, "^7Grand theft auto reported at "..street_name..". Car is a "..color.." "..model.." with plate "..plate)
