...
jobs = {
    ...
    [2] = {id = 2, name = "Police", pay = {on=1500,off=100}},
    ...
    [15] = {id = 15, name = "Emergency", pay = {on = 1500, off = 100}},
    ...
    [25] = {id = 25, name = "Bus Driver", pay = 250},
    [26] = {id = 26, name = "Journalist", pay = 250},
...
function setupCharacter(source, data)
    ...
    self["hunters_license"] = data["hunters_license"]
    ...
    method["update"] = function()
        ...
        exports["GHMattiMySQL"]:QueryAsync("UPDATE characters SET wallet=@wallet, bank=@bank, dirty_cash=@dirty_cash, timeplayed=@timeplayed, position_x=@position_x, position_y=@position_y, position_z=@position_z, weapon_license=@weapon_license, jail_time=@jail_time, job_id=@job_id, drivers_license=@drivers_license, weapon_license=@weapon_license WHERE (identifier=@identifier) AND (character_id=@character_id)", {
    ...
    exports["GHMattiMySQL"]:Insert("characters", {
        {
            ...
            ["hunters_license"] = Config["Character"]["Licenses"]["Hunters"],
    ...
    if identifier ~= nil and data.character_id ~= nil then
        exports["GHMattiMySQL"]:QueryResultAsync("SELECT * FROM characters WHERE (identifier = @identifier) AND (character_id = @character_id)", {["@identifier"] = identifier, ["@character_id"] = data.character_id}, function(_Character)
            if _Character[1] then
                ...
                TriggerClientEvent("hunters:set_license", source, Characters[source].get("hunters_license"))
