...
local charges = {
    {title="1st Degree Felonies", items = {
        ...
        {charge="Possession of CDS w/ Intent to Distribute (30+)", time=600, cost=10000},
        {charge="Possession of CDS w/ Intent to Distribute (60+)", time=600, cost=15000},
        {charge="Possession of CDS w/ Intent to Distribute (120+)", time=600, cost=25000},
    }},
    {title="2nd Degree Felonies", items = {
        {charge="Possession of CDS w/ Intent to Distribute (11+)", time=500, cost=5000},
    ...
    {title="3rd Degree Felonies", items = {
        ...
        {charge="Poss. of Firearm by Convicted Felon", time=500, cost=5000},
...
AddEventHandler("police:menu_citizen", function()
    ...
    exports.ui:addOption("Supply user with a hunting license", [[TriggerEvent("police:menu_citizen_give_hunting_license")]])
...
AddEventHandler("police:menu_citizen_search", function()
    ...
    exports.ui:addOption("Hunting License", [[TriggerEvent("police:menu_citizen_search_execute", "hl")]])
...
AddEventHandler("police:menu_citizen_seize", function()
    ...
    exports.ui:addOption("Hunting License", [[TriggerEvent("police:menu_citizen_seize_execute", "hl")]])
...
AddEventHandler("police:menu_citizen_give_hunting_license", function()
    local t, distance = GetClosestPlayer()
    if(distance ~= -1 and distance < 3) then
        TriggerServerEvent("hunters:givelicense", GetPlayerServerId(t))
    else
        Notify("Please get closer to the target!", 2500)
    end
end)
