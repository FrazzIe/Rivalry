...
local function openPhone()
	...
	local model = GetHashKey("prop_player_phone_01")
	...
	table.insert(phoneObject, object)
...
local function DestroyObject(Handle)
...
local function closePhone()
	...
	if current_call == nil then
		for k, v in ipairs(phoneObject) do
			DestroyObject(v)
			phoneObject = {}
		end
	end
