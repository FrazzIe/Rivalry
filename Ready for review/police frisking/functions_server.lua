...
local Weapons = {
        {model="WEAPON_PISTOL", desc="You feel a pistol on their waistline"},
        {model="WEAPON_COMBATPISTOL", desc="You feel a pistol on their waistline"},
        {model="WEAPON_PISTOL50", desc="You feel a large pistol on their waistline"},
        {model="WEAPON_SNSPISTOL", desc="You feel a small pistol on their waistline"},
        {model="WEAPON_VINTAGEPISTOL", desc="You feel a large pistol on their waistline"},
        {model="WEAPON_STUNGUN", desc="You feel a thick pistol on their waistline"},
        {model="WEAPON_FLAREGUN", desc="You feel a thick pistol on their waistline"},
        {model="WEAPON_KNIFE", desc="You feel a very sharp object"},
        {model="WEAPON_NIGHTSTICK", desc="You feel a long L shaped object"},
        {model="WEAPON_HAMMER", desc="You feel a solid object, feels like a hammer"},
        {model="WEAPON_BOTTLE", desc="You feel a very sharp object on them"},
        {model="WEAPON_DAGGER", desc="You feel a long sharp object near their waste"},
        {model="WEAPON_KNUCKLE", desc="You feel a short round object"},
        {model="WEAPON_MACHETE", desc="You feel a very long and sharp blade"},
        {model="WEAPON_FLASHLIGHT", desc="You feel a flashlight"},
        {model="WEAPON_SWITCHBLADE", desc="You feel a small solid object."},
        {model="WEAPON_DBSHOTGUN", desc="You feel a thick object with two barrels"},
    },
