...
local Weapons = {
        {model="WEAPON_PISTOL", desc="You feel a metal L shaped object near the persons waist."},
        {model="WEAPON_COMBATPISTOL", desc="You feel a metal L shaped object near the persons waist."},
        {model="WEAPON_PISTOL50", desc="You feel a large metal L shaped object near the persons waist."},
        {model="WEAPON_SNSPISTOL", desc="You feel a small metal L shaped object near the persons waist."},
        {model="WEAPON_VINTAGEPISTOL", desc="You feel a metal object with a long barrel near the person waist."},
        {model="WEAPON_STUNGUN", desc="You feel a thicc plastic object on their waist."},
        {model="WEAPON_KNIFE", desc="You feel a very sharp object, with a round base."},
        {model="WEAPON_NIGHTSTICK", desc="You feel a long L shaped object."},
        {model="WEAPON_HAMMER", desc="You feel a wooden handle, with a metal piece on top."},
        {model="WEAPON_BOTTLE", desc="You feel a very sharp glass object on them."},
        {model="WEAPON_DAGGER", desc="You feel a long sharp metal object near their waist."},
        {model="WEAPON_KNUCKLE", desc="You feel a round metal object, with large holes inside of it."},
        {model="WEAPON_FLASHLIGHT", desc="You feel a metal cylinder, with a round head near the persons waist."},
        {model="WEAPON_SWITCHBLADE", desc="You feel a small metal object in their pocket."},
        {model="WEAPON_DBSHOTGUN", desc="You feel a thicc metal object with 2 rounded barrels near their waist."},
    },
			...
			if _weapon ~= nil then
				if tablelength(_weapon) > 0 then
					for k,v in pairs(_weapon) do
						...
						for j,k in ipairs(Weapons) do
							if k.model == WeaponModel then
								TriggerClientEvent("pNotify:SendNotification", source, {text = "".. k.desc.."",type = "error",queue = "left",timeout = 10000,layout = "centerRight"})
							end
						end
					end
				else
					TriggerClientEvent("pNotify:SendNotification", source, {text = "No did not feel any weapons.",type = "error",queue = "left",timeout = 2500,layout = "centerRight"})
				end
			end
		end)
	end
