...
local doors = {
	single = {
		...
		[44] = {x = 2050.6770019531, y = 2963.6096191406, z = -67.152450561523, model = -147325430, heading = 54.675048828125, locked = true}, -- Interogation Room 1
		...
		[46] = {x = 2054.6967773438, y = 2980.51953125, z = -67.152450561523, model = -147325430, heading = 54.675048828125, locked = true}, -- Interogation Room 3
...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(0)
		for k, v in ipairs(chairs) do
			local entity = GetClosestObjectOfType(v.x, v.y, v.z, 1, v.model, 0, 1, 1)
