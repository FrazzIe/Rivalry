...
AddEventHandler("core:ready", function()
    ...
    Chat.Command({"cam", "camera"}, function(source, args, fullCommand)
        TriggerEvent("Cam:ToggleCam")
    end, false, {Help = "Toggle News Camera!", Params = {}})

    Chat.Command({"mic", "microphone"}, function(source, args, fullCommand)
        TriggerEvent("Mic:ToggleMic")
    end, false, {Help = "Toggle News Microphone!", Params = {}})

    Chat.Command({"bmic", "boommic"}, function(source, args, fullCommand)
        TriggerEvent("Mic:ToggleBMic")
    end, false, {Help = "Toggle News Boom Microphone!", Params = {}})
