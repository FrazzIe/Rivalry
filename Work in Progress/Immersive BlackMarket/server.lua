...
Weapons = {
	...
	["WEAPON_COMPACTRIFLE"] = 30000,
	["WEAPON_ADVANCEDRIFLE"] = 1,
	["WEAPON_ASSAULTRIFLE"] = 40000,
...
BlackMarket_Weapons = {
	...
	["WEAPON_SNSPISTOL"] = 700,
	["WEAPON_APPISTOL"] = 1250,
	["WEAPON_VINTAGEPISTOL"] = 700,
	["WEAPON_REVOLVER"] = 800,
	["WEAPON_MARKSMANPISTOL"] = 1,
	["WEAPON_FLAREGUN"] = 1,
	["WEAPON_STUNGUN"] = 1,
...
AddEventHandler("weapon:delete", function(source, cop)
	local source = source
	TriggerEvent("core:getuser", source, function(user)
		exports["GHMattiMySQL"]:QueryAsync("DELETE FROM weapons WHERE (character_id=@character_id)", {
			["@character_id"] = user.get("characterID"),
		})
		TriggerClientEvent("Forensics.ConfiscateWeapon", cop, user_weapons)
		user_weapons[source] = {}
		TriggerClientEvent("weapon:set", source, user_weapons[source])
		TriggerClientEvent("weapon:give", source)
		TriggerClientEvent("weapon:sync", -1, user_weapons)
