...
AddEventHandler("inventory:drop",function(item_id, item_name, quantity, nearbyPlayers, PlayerCoords)
    local source = tonumber(source)
    TriggerEvent('core:getuser', source, function(user)
        ...
        if (user_inventory[source][item_id].quantity - quantity) <= 0 then
            ...
            table.insert(DroppedItems, DroppedItem)
            TriggerClientEvent("Inventory.Sync.Dropped.Items", -1, DroppedItems)
            TriggerClientEvent("Inventory.Draw.Object.Item", source, DroppedItem)
            TriggerClientEvent("inventory:updateitems", source, user_inventory[source])
            TriggerClientEvent("inventory:sync", -1, user_inventory)
        end
    end)
...
RegisterServerEvent("Inventory.Pickup.Item")
AddEventHandler("Inventory.Pickup.Item", function(ItemIndex)
    local Source = source
    local Item = {}
