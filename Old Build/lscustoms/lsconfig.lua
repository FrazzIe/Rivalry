...
----Front wheel (Bikes)----
	frontwheel = {
		{name = "Stock", wtype = 6, mod = -1, price = 400},
...
----Sport wheels-----
	sportwheels = {
		{name = "Stock", wtype = 0, mod = -1, price = 400},
		{name = "Inferno", wtype = 0, mod = 0, price = 400},
		{name = "Deepfive", wtype = 0, mod = 1, price = 400},
		{name = "Lozspeed", wtype = 0, mod = 2, price = 400},
		{name = "Diamondcut", wtype = 0, mod = 3, price = 400},
		{name = "Chrono", wtype = 0, mod = 4, price = 400},
		{name = "Feroccirr", wtype = 0, mod = 5, price = 400},
		{name = "Fiftynine", wtype = 0, mod = 6, price = 400},
		{name = "Mercie", wtype = 0, mod = 7, price = 400},
		{name = "Syntheticz", wtype = 0, mod = 8, price = 400},
		{name = "Organictyped", wtype = 0, mod = 9, price = 400},
		{name = "Endov1", wtype = 0, mod = 10, price = 400},
		{name = "Duper7", wtype = 0, mod = 11, price = 400},
		{name = "Uzer", wtype = 0, mod = 12, price = 400},
		{name = "Groundride", wtype = 0, mod = 13, price = 400},
		{name = "Spacer", wtype = 0, mod = 14, price = 400},
		{name = "Venum", wtype = 0, mod = 15, price = 400},
		{name = "Cosmo", wtype = 0, mod = 16, price = 400},
		{name = "Dashvip", wtype = 0, mod = 17, price = 400},
		{name = "Icekid", wtype = 0, mod = 18, price = 400},
		{name = "Ruffeld", wtype = 0, mod = 19, price = 400},
		{name = "Wangenmaster", wtype = 0, mod = 20, price = 400},
		{name = "Superfive", wtype = 0, mod = 21, price = 400},
		{name = "Endov2", wtype = 0, mod = 22, price = 400},
		{name = "Slitsix", wtype = 0, mod = 23, price = 400},
	},
-----Suv wheels------
	suvwheels = {
		{name = "Stock", wtype = 3, mod = -1, price = 400},
		{name = "Vip", wtype = 3, mod = 0, price = 400},
		{name = "Benefactor", wtype = 3, mod = 1, price = 400},
		{name = "Cosmo", wtype = 3, mod = 2, price = 400},
		{name = "Bippu", wtype = 3, mod = 3, price = 400},
		{name = "Royalsix", wtype = 3, mod = 4, price = 400},
		{name = "Fagorme", wtype = 3, mod = 5, price = 400},
		{name = "Deluxe", wtype = 3, mod = 6, price = 400},
		{name = "Icedout", wtype = 3, mod = 7, price = 400},
		{name = "Cognscenti", wtype = 3, mod = 8, price = 400},
		{name = "Lozspeedten", wtype = 3, mod = 9, price = 400},
		{name = "Supernova", wtype = 3, mod = 10, price = 400},
		{name = "Obeyrs", wtype = 3, mod = 11, price = 400},
		{name = "Lozspeedballer", wtype = 3, mod = 12, price = 400},
		{name = "Extra vaganzo", wtype = 3, mod = 13, price = 400},
		{name = "Splitsix", wtype = 3, mod = 14, price = 400},
		{name = "Empowered", wtype = 3, mod = 15, price = 400},
		{name = "Sunrise", wtype = 3, mod = 16, price = 400},
		{name = "Dashvip", wtype = 3, mod = 17, price = 400},
		{name = "Cutter", wtype = 3, mod = 18, price = 400},
	},
-----Offroad wheels-----
	offroadwheels = {
		{name = "Stock", wtype = 4, mod = -1, price = 400},
		{name = "Raider", wtype = 4, mod = 0, price = 400},
		{name = "Mudslinger", wtype = 4, modtype = 23, wtype = 4, mod = 1, price = 400},
		{name = "Nevis", wtype = 4, mod = 2, price = 400},
		{name = "Cairngorm", wtype = 4, mod = 3, price = 400},
		{name = "Amazon", wtype = 4, mod = 4, price = 400},
		{name = "Challenger", wtype = 4, mod = 5, price = 400},
		{name = "Dunebasher", wtype = 4, mod = 6, price = 400},
		{name = "Fivestar", wtype = 4, mod = 7, price = 400},
		{name = "Rockcrawler", wtype = 4, mod = 8, price = 400},
		{name = "Milspecsteelie", wtype = 4, mod = 9, price = 400},
	},
-----Tuner wheels------
	tunerwheels = {
		{name = "Stock", wtype = 5, mod = -1, price = 400},
		{name = "Cosmo", wtype = 5, mod = 0, price = 400},
		{name = "Supermesh", wtype = 5, mod = 1, price = 400},
		{name = "Outsider", wtype = 5, mod = 2, price = 400},
		{name = "Rollas", wtype = 5, mod = 3, price = 400},
		{name = "Driffmeister", wtype = 5, mod = 4, price = 400},
		{name = "Slicer", wtype = 5, mod = 5, price = 400},
		{name = "Elquatro", wtype = 5, mod = 6, price = 400},
		{name = "Dubbed", wtype = 5, mod = 7, price = 400},
		{name = "Fivestar", wtype = 5, mod = 8, price = 400},
		{name = "Slideways", wtype = 5, mod = 9, price = 400},
		{name = "Apex", wtype = 5, mod = 10, price = 400},
		{name = "Stancedeg", wtype = 5, mod = 11, price = 400},
		{name = "Countersteer", wtype = 5, mod = 12, price = 400},
		{name = "Endov1", wtype = 5, mod = 13, price = 400},
		{name = "Endov2dish", wtype = 5, mod = 14, price = 400},
		{name = "Guppez", wtype = 5, mod = 15, price = 400},
		{name = "Chokadori", wtype = 5, mod = 16, price = 400},
		{name = "Chicane", wtype = 5, mod = 17, price = 400},
		{name = "Saisoku", wtype = 5, mod = 18, price = 400},
		{name = "Dishedeight", wtype = 5, mod = 19, price = 400},
		{name = "Fujiwara", wtype = 5, mod = 20, price = 400},
		{name = "Zokusha", wtype = 5, mod = 21, price = 400},
		{name = "Battlevill", wtype = 5, mod = 22, price = 400},
		{name = "Rallymaster", wtype = 5, mod = 23, price = 400},
	},
-----Highend wheels------
	highendwheels = {
		{name = "Stock", wtype = 7, mod = -1, price = 400},
		{name = "Shadow", wtype = 7, mod = 0, price = 400},
		{name = "Hyper", wtype = 7, mod = 1, price = 400},
		{name = "Blade", wtype = 7, mod = 2, price = 400},
		{name = "Diamond", wtype = 7, mod = 3, price = 400},
		{name = "Supagee", wtype = 7, mod = 4, price = 400},
		{name = "Chromaticz", wtype = 7, mod = 5, price = 400},
		{name = "Merciechlip", wtype = 7, mod = 6, price = 400},
		{name = "Obeyrs", wtype = 7, mod = 7, price = 400},
		{name = "Gtchrome", wtype = 7, mod = 8, price = 400},
		{name = "Cheetahr", wtype = 7, mod = 9, price = 400},
		{name = "Solar", wtype = 7, mod = 10, price = 400},
		{name = "Splitten", wtype = 7, mod = 11, price = 400},
		{name = "Dashvip", wtype = 7, mod = 12, price = 400},
		{name = "Lozspeedten", wtype = 7, mod = 13, price = 400},
		{name = "Carboninferno", wtype = 7, mod = 14, price = 400},
		{name = "Carbonshadow", wtype = 7, mod = 15, price = 400},
		{name = "Carbonz", wtype = 7, mod = 16, price = 400},
		{name = "Carbonsolar", wtype = 7, mod = 17, price = 400},
		{name = "Carboncheetahr", wtype = 7, mod = 18, price = 400},
		{name = "Carbonsracer", wtype = 7, mod = 19, price = 400},
	},
-----Lowrider wheels------
	lowriderwheels = {
		{name = "Stock", wtype = 2, mod = -1, price = 400},
		{name = "Flare", wtype = 2, mod = 0, price = 400},
		{name = "Wired", wtype = 2, mod = 1, price = 400},
		{name = "Triplegolds", wtype = 2, mod = 2, price = 400},
		{name = "Bigworm", wtype = 2, mod = 3, price = 400},
		{name = "Sevenfives", wtype = 2, mod = 4, price = 400},
		{name = "Splitsix", wtype = 2, mod = 5, price = 400},
		{name = "Freshmesh", wtype = 2, mod = 6, price = 400},
		{name = "Leadsled", wtype = 2, mod = 7, price = 400},
		{name = "Turbine", wtype = 2, mod = 8, price = 400},
		{name = "Superfin", wtype = 2, mod = 9, price = 400},
		{name = "Classicrod", wtype = 2, mod = 10, price = 400},
		{name = "Dollar", wtype = 2, mod = 11, price = 400},
		{name = "Dukes", wtype = 2, mod = 12, price = 400},
		{name = "Lowfive", wtype = 2, mod = 13, price = 400},
		{name = "Gooch", wtype = 2, mod = 14, price = 400},
	},
-----Muscle wheels-----
	musclewheels = {
		{name = "Stock", wtype = 1, mod = -1, price = 400},
		{name = "Classicfive", wtype = 1, mod = 0, price = 400},
		{name = "Dukes", wtype = 1, mod = 1, price = 400},
		{name = "Musclefreak", wtype = 1, mod = 2, price = 400},
		{name = "Kracka", wtype = 1, mod = 3, price = 400},
		{name = "Azrea", wtype = 1, mod = 4, price = 400},
		{name = "Mecha", wtype = 1, mod = 5, price = 400},
		{name = "Blacktop", wtype = 1, mod = 6, price = 400},
		{name = "Dragspl", wtype = 1, mod = 7, price = 400},
		{name = "Revolver", wtype = 1, mod = 8, price = 400},
		{name = "Classicrod", wtype = 1, mod = 9, price = 400},
		{name = "Spooner", wtype = 1, mod = 10, price = 400},
		{name = "Fivestar", wtype = 1, mod = 11, price = 400},
		{name = "Oldschool", wtype = 1, mod = 12, price = 400},
		{name = "Eljefe", wtype = 1, mod = 13, price = 400},
		{name = "Dodman", wtype = 1, mod = 14, price = 400},
		{name = "Sixgun", wtype = 1, mod = 15, price = 400},
		{name = "Mercenary", wtype = 1, mod = 16, price = 400},
	},
...
---------Headlights---------
	[22] = {
		...
		{name = "Xenon Lights", mod = 1, price = 1750},
	},
	
----------Turbo---------
	[18] = {
		{ name = "None", mod = 0, price = 0},
		{ name = "Turbo Tuning", mod = 1, price = 75000},
	},
	
-----------Armor-------------
	[16] = {
		{name = "Armor Upgrade 20%",modtype = 16, mod = 0, price = 20000},
...
---------Suspension-----------
	[15] = {
		...
		{name = "Competition Suspension",mod = 3, price = 4500},
	},
...
-----------Brakes-------------
	[12] = {
		...
		{name = "Sport Brakes", mod = 1, price = 1500},
