...
cars = {
    ...
    {name = "2010 Marked Charger", model = "pd9", type = "", rank = "recruit"},
    ...
    {name = "2014 Marked Tahoe", model = "pd8", type = "", rank = "officer i"},
...
heli = {
	...
	{name = "Ranger Buzzard", model = "buzzard", type = "helicopter", rank = "officer ii"},
}
