...
local charges = {
    {title="1st Degree Felonies", items = {
        {charge="Aggravated Murder of LEO", time=900, cost=9000},
        {charge="Attempted Murder of LEO", time=840, cost=8400},
        {charge="Felony Murder", time=720, cost=7200},
        {charge="Attempted Murder", time=600, cost=6000},
        {charge="Kidnapping", time=600, cost=6000},
        {charge="Aggravated Armed Robbery", time=600, cost=6000},
        {charge="Armed Bank Robbery", time=600, cost=6000},
        {charge="Grand Theft Auto", time=480, cost=5000},
        {charge="Racketeering", time=600, cost=6000},
        {charge="Possession of CDS w/ Intent to Distribute (Cannabis 30+)", time=600, cost=15000},
        {charge="Possession of CDS w/ Intent to Distribute (Cannabis 60+)", time=600, cost=20000},
        {charge="Possession of CDS w/ Intent to Distribute (Cannabis 120+)", time=600, cost=25000},
        {charge="Drug Trafficking (Cocaine)", time=600, cost=25000},
        {charge="Possession of CDS w/ Intent to Distribute (Cocaine 0-30)", time=600, cost=15000},
        {charge="Possession of CDS w/ Intent to Distribute (Cocaine 30+)", time=600, cost=20000},
        {charge="Possession of CDS w/ Intent to Distribute (Cocaine 60+)", time=600, cost=25000},
        {charge="Possession of CDS w/ Intent to Distribute (Cocaine 120+)", time=600, cost=30000},
    }},
    {title="2nd Degree Felonies", items = {
        {charge="Possession of CDS w/ Intent to Distribute (11+)", time=500, cost=10000},
        {charge="Manslaughter", time=600, cost=6000},
        {charge="Negligent Homicide", time=420, cost=4200},
        {charge="Vehicular Manslaughter", time=420, cost=4200},
        {charge="Attempted Kidnapping", time=480, cost=4800},
        {charge="Felonious Restraint", time=400, cost=4000},
        {charge="Grand Theft", time=420, cost=4200},
        {charge="Robbery", time=420, cost=4200},
        {charge="Petty Theft with Prior", time=500, cost=5000},
        {charge="Petty Theft", time=390, cost=3900},
        {charge="Drug Trafficking", time=500, cost=5000},
        {charge="Escape While Armed", time=420, cost=4200},
        {charge="Sale of CDS", time=600, cost=8000},
    }},
    {title="3rd Degree Felonies", items = {
        {charge="Aggravated Assault", time=420, cost=4200},
        {charge="Hit and Run With Injuries", time=600, cost=6000},
        {charge="Poss. of Class 2 Illegal Firearm/Weapon", time=600, cost=6000},
        {charge="Poss. of Firearm by Convicted Violent Felon", time=500, cost=5000},
        {charge="Identity Theft by a Convicted Felon", time=420, cost=4200},
        {charge="Attempted or Unarmed Robbery", time=420, cost=4200},
        {charge="Perjury", time=390, cost=3900},
        {charge="Attempted Bribery", time=420, cost=4200},
        {charge="Fleeing/Eluding Law Enforcement (Death/Injury)", time=420, cost=4200},
        {charge="Escape", time=390, cost=3900},
        {charge="Rioting", time=480, cost=4800},
        {charge="Cultivation of CDS (0-30", time=200, cost=5000},
        {charge="Cultivation of CDS (30-60", time=200, cost=10000},
        {charge="Cultivation of CDS (60+", time=200, cost=15000},
    }},
    {title="1st Degree Misdemeanors", items = {
        {charge="Aiding and Abetting", time=300, cost=3000},
        {charge="Assault", time=300, cost=3000},
        {charge="Attempted Grand Theft Auto", time=300, cost=3000},
        {charge="Contempt of Court", time=1200, cost=25000},
        {charge="Obstruction of Justice", time=390, cost=3900},
        {charge="Damage to State Property", time=390, cost=3900},
        {charge="Fleeing/Eluding Law Enforcement", time=300, cost=3000},
        {charge="Money Laundering", time=300, cost=3000},
        {charge="Negligent Discharge of Firearm in Public", time=300, cost=3000},
        {charge="False Imprisonment", time=400, cost=4000},
        {charge="Domestic Violence", time=300, cost=3000},
        {charge="Threat of Bodily Harm", time=300, cost=3000},
        {charge="Reckless Endangerment", time=480, cost=4800},
        {charge="Hit and Run No Injuries", time=300, cost=3000},
        {charge="Criminal Trespass", time=300, cost=3000},
        {charge="Identity Theft", time=300, cost=3000},
        {charge="Tampering With Evidence", time=390, cost=3900},
        {charge="False Identification", time=300, cost=3000},
        {charge="Misuse of 911", time=300, cost=3000},
        {charge="Misuse of Taser/Wasting Police Resources", time=300, cost=3000},
        {charge="Indecent Exposure", time=300, cost=3000},
        {charge="Extortion/Blackmail", time=300, cost=3000},
        {charge="Prostitution", time=300, cost=3000},
        {charge="Gambling", time=300, cost=3000},
        {charge="Social Media Hate Crime", time=600, cost=6000},
        {charge="Conspiracy", time=600, cost=6000},
        {charge="False Personation", time=400, cost=4000},

    }},
    {title="2nd Degree Misdemeanors", items = {
        {charge="Reckless Driving", time=300, cost=3000},
        {charge="Poss. of Stolen Vehicle", time=300, cost=3000},
        {charge="Damage to Public Property", time=300, cost=3000},
        {charge="Damage to Private Property", time=120, cost=2500},
        {charge="Poss. of Burglary Tools", time=300, cost=3000},
        {charge="Poss. of Weapon w/ Criminal Intent", time=300, cost=3000},
        {charge="Poss. of Illegal Contraband", time=300, cost=3000},
        {charge="Failure to Obey a Lawful Order", time=300, cost=3000},
        {charge="Illegal Brandishing of Firearm", time=300, cost=3000},
        {charge="Defamation", time=300, cost=3000},
    }},
    {title="3rd Degree Misdemeanors", items = {
        {charge="Resisting Arrest", time=300, cost=3000},
        ...
        {charge="Disorderly Conduct", time=120, cost=1500},
        {charge="Poss. of Firearm w/o a Weapons License", time=300, cost=3000},
...
AddEventHandler("police:menu_addcharge", function(data)
	...
	local time = tonumber(KeyboardInput("Enter time:", tostring(data.time), 11))
