...
local charges = {
    {title="1st Degree Felonies", items = {
        ...
        {charge="Attempted Murder of LEO", time=15, cost=7500},
        {charge="Felony Murder", time=40, cost=20000},
        {charge="Attempted Murder", time=15, cost=7500},
    ...
    {title="2nd Degree Felonies", items = {
        {charge="Poss. of CDS w/ Intent to Dist. (Weed/Cannabis 11+)", time=5, cost=2500},
        {charge="Poss. of CDS w/ Intent to Dist. (Weed/Cannabis 30+)", time=5, cost=5000},
        {charge="Poss. of CDS w/ Intent to Dist. (Weed/Cannabis 60+)", time=5, cost=7500},
        {charge="Poss. of CDS w/ Intent to Dist. (Weed/Cannabis 120+)", time=5, cost=10000},
        {charge="Poss. of CDS w/ Intent to Dist. (Cocaine 0-30)", time=5, cost=5000},
        {charge="Poss. of CDS w/ Intent to Dist. (Cocaine 30+)", time=5, cost=7500},
        {charge="Poss. of CDS w/ Intent to Dist. (Cocaine 60+)", time=5, cost=10000},
        {charge="Poss. of CDS w/ Intent to Dist. (Cocaine 120+)", time=5, cost=12500},
        {charge="Drug Trafficking (CDS in vehicle)", time=5, cost=1000},
        {charge="Sale of CDS", time=5, cost=1000},
        ...
        {charge="Attempted Kidnapping", time=4, cost=1500},
        {charge="Felonious Restraint", time=5, cost=500},
        {charge="Grand Theft", time=5, cost=500},
        {charge="Robbery", time=5, cost=500},
        {charge="Petty Theft with Prior", time=3, cost=500},
        {charge="Petty Theft", time=3, cost=500},
        {charge="Escape While Armed", time=3, cost=500},
    }},
    {title="3rd Degree Felonies", items = {
        {charge="Aggravated Assault", time=5, cost=1500},
        {charge="Hit and Run With Injuries", time=5, cost=1500},
        {charge="Poss. of Class 2 Illegal Firearm/Weapon", time=5, cost=1500},
        {charge="Poss. of Firearm by Convicted Violent Felon", time=5, cost=1500},
        {charge="Identity Theft by a Convicted Felon", time=5, cost=1500},
        {charge="Attempted or Unarmed Robbery", time=5, cost=1500},
        {charge="Perjury", time=5, cost=1500},
        {charge="Attempted Bribery", time=3, cost=1500},
        {charge="Fleeing/Eluding Law Enforcement (Death/Injury)", time=5, cost=1000},
        {charge="Escape", time=5, cost=1500},
        {charge="Rioting", time=5, cost=1500},
    }},
    {title="1st Degree Misdemeanors", items = {
        {charge="Aiding and Abetting", time=5, cost=1000},
        {charge="Assault", time=5, cost=1000},
        {charge="Attempted Grand Theft Auto", time=5, cost=1000},
        {charge="Contempt of Court", time=5, cost=1000},
        {charge="Obstruction of Justice", time=5, cost=1000},
        {charge="Damage to State Property", time=5, cost=1000},
        {charge="Fleeing/Eluding Law Enforcement", time=5, cost=1000},
        {charge="Money Laundering", time=5, cost=1000},
        {charge="Negligent Discharge of Firearm in Public", time=5, cost=1000},
        {charge="False Imprisonment", time=5, cost=1000},
        {charge="Domestic Violence", time=5, cost=1000},
        {charge="Threat of Bodily Harm", time=5, cost=1000},
        {charge="Reckless Endangerment", time=5, cost=1000},
        {charge="Hit and Run No Injuries", time=5, cost=1000},
        {charge="Criminal Trespass", time=5, cost=1000},
        {charge="Identity Theft", time=5, cost=1000},
        {charge="Tampering With Evidence", time=5, cost=1000},
        {charge="False Identification", time=5, cost=1000},
        {charge="Misuse of 911", time=5, cost=500},
        {charge="Misuse of Taser/Wasting Police Resources", time=5, cost=500},
        {charge="Indecent Exposure", time=5, cost=500},
        {charge="Extortion/Blackmail", time=5, cost=500},
        {charge="Prostitution", time=5, cost=500},
        {charge="Gambling", time=5, cost=500},
        {charge="Social Media Hate Crime", time=5, cost=500},
        {charge="Conspiracy", time=5, cost=500},
        {charge="False Personation", time=5, cost=500},

    }},
    {title="2nd Degree Misdemeanors", items = {
        {charge="Reckless Driving", time=5, cost=1000},
        {charge="Poss. of Stolen Vehicle", time=5, cost=1000},
        {charge="Poss. of Counterfeit Currency", time=5, cost=1000},
        ...
        {charge="Illegal Brandishing of Firearm", time=5, cost=1000},
