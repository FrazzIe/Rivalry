...
local charges = {
    ...
    {title="1st Degree Misdemeanors", items = {
        {charge="Aiding and Abetting", time=5, cost=1500},
        ...
        {charge="Negligent Discharge of Firearm in Public", time=5, cost=1500},
        ...
        {charge="Tampering With Evidence", time=5, cost=1250},
        {charge="False Identification", time=5, cost=1250},
        {charge="Misuse of 911", time=5, cost=1250},
        {charge="Misuse of Taser/Wasting Police Resources", time=5, cost=1250},
    ...
    {title="3rd Degree Misdemeanors", items = {
        ...
        {charge="Illegal Sale/Transfer of Firearm(s)", time=5, cost=2500},
