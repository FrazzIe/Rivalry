...
local charges = {
    ...
    {title="2nd Degree Felonies", items = {
        ...
        {charge="Sale of CDS", time=5, cost=500},
    ...
    {title="1st Degree Misdemeanors", items = {
        {charge="Aiding and Abetting", time=5, cost=500},
        {charge="Assault", time=5, cost=500},
        {charge="Attempted Grand Theft Auto", time=5, cost=500},
        {charge="Contempt of Court", time=5, cost=5000},
        {charge="Obstruction of Justice", time=5, cost=500},
        {charge="Damage to State Property", time=5, cost=500},
        {charge="Fleeing/Eluding Law Enforcement", time=5, cost=500},
        {charge="Money Laundering", time=5, cost=500},
        {charge="Negligent Discharge of Firearm in Public", time=5, cost=500},
        {charge="False Imprisonment", time=5, cost=500},
        {charge="Domestic Violence", time=5, cost=500},
        {charge="Threat of Bodily Harm", time=5, cost=500},
        {charge="Reckless Endangerment", time=5, cost=500},
        {charge="Hit and Run No Injuries", time=5, cost=500},
        {charge="Criminal Trespass", time=5, cost=500},
        {charge="Identity Theft", time=5, cost=500},
        {charge="Tampering With Evidence", time=5, cost=500},
        {charge="False Identification", time=5, cost=500},
    ...
    {title="2nd Degree Misdemeanors", items = {
        {charge="Reckless Driving", time=5, cost=500},
        {charge="Poss. of Stolen Vehicle", time=5, cost=500},
        {charge="Poss. of Counterfeit Currency", time=5, cost=500},
        {charge="Damage to Public Property", time=2, cost=500},
        {charge="Damage to Private Property", time=2, cost=500},
        ...
        {charge="Failure to Obey a Lawful Order", time=5, cost=500},
        {charge="Illegal Brandishing of Firearm", time=5, cost=500},
        {charge="Defamation", time=5, cost=500},
    }},
    {title="3rd Degree Misdemeanors", items = {
        {charge="Resisting Arrest", time=6, cost=500},
        ...
        {charge="Poss. of Firearm w/o a Weapons License", time=4, cost=250},
        {charge="Illegal Sale/Transfer of Firearm(s)", time=5, cost=750},
        {charge="Disturbing the Peace (Non-optional Fine)", time=0, cost=250},
        {charge="Harassment (Non-optional Fine)", time=0, cost=250},
        {charge="Domestic Disturbence (Non-optional Fine)", time=0, cost=250},
    ...
    {title="Traffic Violations", items = {
        ...
        {charge="Failure to Obey LEO Signals", time=0, cost=300},
