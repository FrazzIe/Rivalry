...
local charges = {
    {title="1st Degree Felonies", items = {
        {charge="Aggravated Murder of LEO", time=40, cost=40000},
        {charge="Attempted Murder of LEO", time=15, cost=15000},
        {charge="Felony Murder", time=40, cost=40000},
        {charge="Attempted Murder", time=15, cost=15000},
        {charge="Kidnapping", time=6, cost=6000},
        {charge="Aggravated Armed Robbery", time=15, cost=15000},
        {charge="Armed Bank Robbery", time=10, cost=10000},
        {charge="Grand Theft Auto", time=5, cost=5000},
        {charge="Racketeering", time=5, cost=5000},
    }},
    {title="2nd Degree Felonies", items = {
        {charge="Poss. of CDS w/ Intent to Dist. (Weed/Cannabis 11+)", time=5, cost=5000},
        {charge="Poss. of CDS w/ Intent to Dist. (Weed/Cannabis 30+)", time=5, cost=7500},
        {charge="Poss. of CDS w/ Intent to Dist. (Weed/Cannabis 60+)", time=5, cost=10000},
        {charge="Poss. of CDS w/ Intent to Dist. (Weed/Cannabis 120+)", time=5, cost=12500},
        {charge="Poss. of CDS w/ Intent to Dist. (Cocaine 0-30)", time=5, cost=7500},
        {charge="Poss. of CDS w/ Intent to Dist. (Cocaine 30+)", time=5, cost=10000},
        {charge="Poss. of CDS w/ Intent to Dist. (Cocaine 60+)", time=5, cost=15000},
        {charge="Poss. of CDS w/ Intent to Dist. (Cocaine 120+)", time=5, cost=20000},
        {charge="Drug Trafficking (CDS in vehicle)", time=5, cost=5000},
        {charge="Sale of CDS", time=5, cost=1500},
        {charge="Manslaughter", time=5, cost=5000},
        {charge="Negligent Homicide", time=5, cost=5000},
        {charge="Vehicular Manslaughter", time=5, cost=5000},
        {charge="Attempted Kidnapping", time=4, cost=4000},
        {charge="Felonious Restraint", time=5, cost=2000},
        {charge="Grand Theft", time=5, cost=2500},
        {charge="Robbery", time=5, cost=2000},
        {charge="Petty Theft with Prior", time=3, cost=1500},
        {charge="Petty Theft", time=3, cost=1500},
        {charge="Escape While Armed", time=3, cost=1500},
    }},
    {title="3rd Degree Felonies", items = {
        {charge="Aggravated Assault", time=5, cost=3000},
        {charge="Hit and Run With Injuries", time=5, cost=3000},
        {charge="Poss. of Class 2 Illegal Firearm/Weapon", time=5, cost=3000},
        {charge="Poss. of Firearm by Convicted Violent Felon", time=5, cost=3000},
        {charge="Identity Theft by a Convicted Felon", time=5, cost=3000},
        {charge="Attempted or Unarmed Robbery", time=5, cost=5000},
    ...
    {title="1st Degree Misdemeanors", items = {
        {charge="Aiding and Abetting", time=5, cost=2000},
        {charge="Assault", time=5, cost=2000},
        {charge="Attempted Grand Theft Auto", time=5, cost=2000},
        {charge="Contempt of Court", time=5, cost=5000},
        {charge="Obstruction of Justice", time=5, cost=5000},
        {charge="Damage to State Property", time=5, cost=2000},
        {charge="Fleeing/Eluding Law Enforcement", time=5, cost=2000},
        {charge="Money Laundering", time=5, cost=2000},
        {charge="Negligent Discharge of Firearm in Public", time=5, cost=2000},
        {charge="False Imprisonment", time=5, cost=2000},
        {charge="Domestic Violence", time=5, cost=2000},
        {charge="Threat of Bodily Harm", time=5, cost=2000},
        {charge="Reckless Endangerment", time=5, cost=2000},
        {charge="Hit and Run No Injuries", time=5, cost=2000},
        {charge="Criminal Trespass", time=5, cost=2000},
        {charge="Identity Theft", time=5, cost=2000},
        {charge="Tampering With Evidence", time=5, cost=2000},
        {charge="False Identification", time=5, cost=2000},
        {charge="Misuse of 911", time=5, cost=500},
        {charge="Misuse of Taser/Wasting Police Resources", time=5, cost=1500},
        {charge="Indecent Exposure", time=5, cost=2000},
        {charge="Extortion/Blackmail", time=5, cost=2000},
        {charge="Prostitution", time=5, cost=2000},
        {charge="Gambling", time=5, cost=500},
        {charge="Social Media Hate Crime", time=5, cost=2000},
        {charge="Conspiracy", time=5, cost=2000},
        {charge="False Personation", time=5, cost=2000},

    }},
    {title="2nd Degree Misdemeanors", items = {
        {charge="Reckless Driving", time=5, cost=1500},
        {charge="Poss. of Stolen Vehicle", time=5, cost=1500},
        {charge="Poss. of Counterfeit Currency", time=5, cost=1500},
        {charge="Damage to Public Property", time=2, cost=1000},
        {charge="Damage to Private Property", time=2, cost=1000},
        {charge="Poss. of Burglary Tools", time=5, cost=500},
        {charge="Poss. of Weapon w/ Criminal Intent", time=5, cost=500},
        {charge="Poss. of Illegal Contraband", time=5, cost=500},
        {charge="Failure to Obey a Lawful Order", time=5, cost=1000},
        {charge="Illegal Brandishing of Firearm", time=5, cost=1500},
        {charge="Defamation", time=5, cost=500},
    }},
    {title="3rd Degree Misdemeanors", items = {
        {charge="Resisting Arrest", time=6, cost=1000},
        {charge="Loitering (Non-optional Fine)", time=0, cost=200},
        {charge="Failure to Inform of Concealed Weapon (Non-optional Fine)", time=0, cost=300},
        {charge="Disorderly Conduct", time=2, cost=200},
        {charge="Poss. of Firearm w/o a Weapons License", time=4, cost=1000},
        {charge="Illegal Sale/Transfer of Firearm(s)", time=5, cost=1000},
        {charge="Disturbing the Peace (Non-optional Fine)", time=0, cost=500},
        {charge="Harassment (Non-optional Fine)", time=0, cost=500},
        {charge="Domestic Disturbence (Non-optional Fine)", time=0, cost=500},
    ...
    {title="Traffic Violations", items = {
        ...
        {charge="Careless Driving", time=0, cost=200},
        {charge="Illegal U-turn", time=0, cost=50},
        {charge="Illegal Window Tint", time=0, cost=50},
        {charge="Fail to Yield to Emergency Services", time=0, cost=300},
        {charge="No insurance/Expired Registration", time=0, cost=25},
        {charge="Fail to Give Right of Way", time=0, cost=25},
        ...
        {charge="Parked Near Fire Hydrant", time=0, cost=50},
        {charge="Fail to Yield to Pedestrian", time=0, cost=50},
        {charge="Failure to Obey LEO Signals", time=0, cost=150},
        {charge="Improper/Unsafe Turn", time=0, cost=25},
        {charge="Improper/Missing Plate", time=0, cost=25},
        {charge="Wrong Way", time=0, cost=50},
