...
local charges = {
    ...
    {title="2nd Degree Felonies", items = {
        {charge="Possession of CDS w/ Intent to Distribute (Cannabis 11+)", time=600, cost=10000},
        ...
        {charge="Drug Trafficking (CDS in vehicle)", time=300, cost=5000},
        {charge="Sale of CDS", time=240, cost=3000},
