...
function save()
    ...
    TriggerServerEvent("police:save_clothing", player_data, isInService)
end
...
RegisterNetEvent("police:load_clothing")
AddEventHandler("police:load_clothing", function(data)
    player_data = data
