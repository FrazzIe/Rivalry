local _Characters = {}
jobs = {
    [1] = {id = 1, name = "Unemployed", pay = 20},
    [2] = {id = 2, name = "Police", pay = {on=250,off=50}},
    [3] = {id = 3, name = "Pharmacist", pay = 50},
    [4] = {id = 4, name = "futurjob2", pay = 50},
    [5] = {id = 5, name = "futurjob", pay = 50},
    [6] = {id = 6, name = "Farmer", pay = 50},
    [7] = {id = 7, name = "Lumberjack", pay = 50},
    [8] = {id = 8, name = "Gang", pay = 50},
    [9] = {id = 9, name = "Miner", pay = 50},
    [10] = {id = 10, name = "Fisher", pay = 50},
    [11] = {id = 11, name = "Docker", pay = 50},
    [12] = {id = 12, name = "Brewer", pay = 50},
    [13] = {id = 13, name = "Vigneron", pay = 50},
    [14] = {id = 14, name = "Livreur", pay = 50},
    [15] = {id = 15, name = "Emergency", pay = {on = 250, off = 50}},
    [16] = {id = 16, name = "Mechanic", pay = 150},
    [17] = {id = 17, name = "Taxi", pay = 100},
    [18] = {id = 18, name = "FBI", pay = 50},
    [19] = {id = 19, name = "Courier", pay = 50},
    [20] = {id = 20, name = "Pool Cleaner", pay = 50}, 
    [21] = {id = 21, name = "Garbage Collector", pay = 50},
    [22] = {id = 22, name = "Tow", pay = 50},
    [23] = {id = 23, name = "DOJ", pay = 500},
    [24] = {id = 24, name = "Trucker", pay = 50},
}
...
AddEventHandler("core:deleteCharacter", function(character)
    ...
    exports["GHMattiMySQL"]:Query("DELETE FROM garages WHERE character_id=@character_id", {["@character_id"] = character.character_id})
    exports["GHMattiMySQL"]:Query("DELETE FROM inventory WHERE character_id=@character_id", {["@character_id"] = character.character_id})
    exports["GHMattiMySQL"]:Query("DELETE FROM models WHERE character_id=@character_id", {["@character_id"] = character.character_id})
    exports["GHMattiMySQL"]:Query("DELETE FROM paramedic WHERE character_id=@character_id", {["@character_id"] = character.character_id})
    exports["GHMattiMySQL"]:Query("DELETE FROM paramedic_models WHERE character_id=@character_id", {["@character_id"] = character.character_id})
    exports["GHMattiMySQL"]:Query("DELETE FROM phone_messages WHERE (source_identifier=@identifier) AND (source_number=(SELECT phone_number FROM phone WHERE (identifier=@identifier) AND (character_id=@character_id))) AND (owner=@identifier)", {["@identifier"] = identifier, ["@character_id"] = character.character_id})
    exports["GHMattiMySQL"]:Query("DELETE FROM phone_messages WHERE (target_identifier=@identifier) AND (target_number=(SELECT phone_number FROM phone WHERE (identifier=@identifier) AND (character_id=@character_id))) AND (owner=@identifier)", {["@identifier"] = identifier, ["@character_id"] = character.character_id})
    exports["GHMattiMySQL"]:Query("DELETE FROM phone_contacts WHERE character_id=@character_id", {["@character_id"] = character.character_id})
    exports["GHMattiMySQL"]:Query("DELETE FROM phone WHERE (identifier=@identifier) AND (character_id=@character_id)", {["@identifier"] = identifier, ["@character_id"] = character.character_id})
    exports["GHMattiMySQL"]:Query("DELETE FROM police WHERE character_id=@character_id", {["@character_id"] = character.character_id})
    exports["GHMattiMySQL"]:Query("DELETE FROM police_models WHERE character_id=@character_id", {["@character_id"] = character.character_id})
    exports["GHMattiMySQL"]:Query("DELETE FROM vehicles WHERE character_id=@character_id", {["@character_id"] = character.character_id})
    exports["GHMattiMySQL"]:Query("DELETE FROM weapons WHERE character_id=@character_id", {["@character_id"] = character.character_id})
...
AddEventHandler("core:killCharacter", function(source)
    ...
    if Characters[source] ~= nil then
        ...
        if character_id and identifier then
            exports["GHMattiMySQL"]:Query("DELETE FROM garages WHERE character_id=@character_id", {["@character_id"] = character_id})
            exports["GHMattiMySQL"]:Query("DELETE FROM inventory WHERE character_id=@character_id", {["@character_id"] = character_id})
            exports["GHMattiMySQL"]:Query("DELETE FROM models WHERE character_id=@character_id", {["@character_id"] = character_id})
            exports["GHMattiMySQL"]:Query("DELETE FROM paramedic WHERE character_id=@character_id", {["@character_id"] = character_id})
            exports["GHMattiMySQL"]:Query("DELETE FROM paramedic_models WHERE character_id=@character_id", {["@character_id"] = character_id})
            exports["GHMattiMySQL"]:Query("DELETE FROM phone_messages WHERE (source_identifier=@identifier) AND (source_number=(SELECT phone_number FROM phone WHERE (identifier=@identifier) AND (character_id=@character_id))) AND (owner=@identifier)", {["@identifier"] = identifier, ["@character_id"] = character_id})
            exports["GHMattiMySQL"]:Query("DELETE FROM phone_messages WHERE (target_identifier=@identifier) AND (target_number=(SELECT phone_number FROM phone WHERE (identifier=@identifier) AND (character_id=@character_id))) AND (owner=@identifier)", {["@identifier"] = identifier, ["@character_id"] = character_id})
            exports["GHMattiMySQL"]:Query("DELETE FROM phone_contacts WHERE character_id=@character_id", {["@character_id"] = character_id})
            exports["GHMattiMySQL"]:Query("DELETE FROM phone WHERE (identifier=@identifier) AND (character_id=@character_id)", {["@identifier"] = identifier, ["@character_id"] = character_id})
            exports["GHMattiMySQL"]:Query("DELETE FROM police WHERE character_id=@character_id", {["@character_id"] = character_id})
            exports["GHMattiMySQL"]:Query("DELETE FROM police_models WHERE character_id=@character_id", {["@character_id"] = character_id})
            exports["GHMattiMySQL"]:Query("DELETE FROM vehicles WHERE character_id=@character_id", {["@character_id"] = character_id})
            exports["GHMattiMySQL"]:Query("DELETE FROM weapons WHERE character_id=@character_id", {["@character_id"] = character_id})
