...
>>>>>>> fa0fcd2cd4d5d17112593f3d0bdf2608e966a8c9
...
Chat.Command("dispatch", function(source, args, rawCommand)
	if args[2] then
		...
		if GetPlayerName(Target) ~= nil then
			...
			for id, dept in pairs(emergency_users) do
				Chat.Message(id, "Dispatch: ", "Sent \""..Message.."\" to caller "..Target..".", 0, 200, 0, true, "dispatch")
			end
        else
        	Chat.Message(source, "Dispatch: ", "Unable to reach caller "..Target, 0, 200, 0, true, "dispatch")
        end
    end
