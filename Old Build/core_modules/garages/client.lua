...
emplacement_garage = {
    ...
    [7] = {name="Personal Garage", colour=3, sprite=357, x=-667.74456787109,y=-2378.0485839844,z=13.8580493927,id=7,gname="Exceptionalists Way [7]",cost=150000,heading=-45.0,maxslots=12}, -- Personal
                        ...
                        Citizen.CreateThread(function()
                            if drivers_license == "true" then 
                             ...
                             TriggerServerEvent("garage:pay_impound") 
                                ...
                                exports.pNotify:SendNotification({text = "You do not have a valid drivers license", type = "success", queue = "left", timeout = 3000, layout = "centerRight"})
                            end
                        end)
                    end
                end)
