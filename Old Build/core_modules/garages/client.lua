...
emplacement_garage = {
    [1] = {name="Public Garage", colour=1, sprite=357, x=-332.88320922852,y=-779.23046875,z=33.964912414551,id=1,gname="Peaceful St [1]",cost=1000,heading=0.0,maxslots=2}, -- Peaceful St
    ...
    [3] = {name="Public Garage", colour=1, sprite=357, x=1232.4792480469,y=2708.3212890625,z=38.005790710449,id=3,gname="Sandy [3]",cost=1000,heading=0.0,maxslots=2}, -- Public Sandy
    [4] = {name="Public Garage", colour=1, sprite=357, x=117.96788024902,y=6599.45703125,z=32.013603210449,id=4,gname="Paleto [4]",cost=1000,heading=-90.0,maxslots=2}, -- Public Paleto
    [5] = {name="Personal Garage", colour=3, sprite=357, x=947.13641357422,y=-1697.9788818359,z=30.085023880005,id=5,gname="Industrial [5]",cost=12000,heading=-95.0,maxslots=6}, -- Personal
    ...
    [7] = {name="Personal Garage", colour=3, sprite=357, x=-667.74456787109,y=-2378.0485839844,z=13.8580493927,id=7,gname="Exceptionalists Way [7]",cost=150000,heading=-45.0,maxslots=4}, -- Personal
    [8] = {name="Personal Garage", colour=3, sprite=357, x=258.68347167969,y=2589.7287597656,z=44.954097747803,id=8,gname="Autoshop Garage [8]",cost=10000,heading=10.0,maxslots=4}, -- Personal
    ...
    [10] = {name="Personal Garage", colour=3, sprite=357, x=-833.24926757813,y=-392.95385742188,z=31.325246810913,id=10,gname="Weazel [10]",cost=15000,heading=225.0,maxslots=6}, -- Personal
    ...
    [12] = {name="Personal Garage", colour=3, sprite=357, x=-84.019691467285,y=-820.99694824219,z=36.028030395508,id=12,gname="Maze Tower [12]",cost=35000,heading=-365.0,maxslots=10}, -- Personal
}
