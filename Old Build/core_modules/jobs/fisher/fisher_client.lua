	...
	Data = {
		...
		Store = {
		    {Category = "Freshly Caught Fish", Items = {
		        ...
		        [7] = {Name = "Herring", Id = 60, price = 100, Max = 100, sold = 0},
		        [8] = {Name = "Salmon", Id = 61, price = 125, Max = 100, sold = 0},
		        [9] = {Name = "Barracuda", Id = 62, price = 150, Max = 100, sold = 0},
		        [10] = {Name = "Tuna", Id = 63, price = 175, Max = 100, sold = 0},
		        [11] = {Name = "Yellowtail", Id = 64, price = 200, Max = 100, sold = 0},
		    }},
		},
		Vehicles ={
			Model = "tug"
