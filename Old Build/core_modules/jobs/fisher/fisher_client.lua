	...
	Data = {
		...
		Store = {
		    {Category = "Freshly Caught Fish", Items = {
		        ...
		        [2] = {Name = "Pompano", Id = 55, price = 60, Max = 100, sold = 0},
		        [3] = {Name = "Snapper", Id = 56, price = 70, Max = 100, sold = 0},
		        [4] = {Name = "Redfish", Id = 57, price = 80, Max = 100, sold = 0},
		        [5] = {Name = "Bass", Id = 58, price = 99, Max = 100, sold = 0},
		        [6] = {Name = "Mackerel", Id = 59, price = 175, Max = 100, sold = 0},
		        [7] = {Name = "Herring", Id = 60, price = 200, Max = 100, sold = 0},
		        [8] = {Name = "Salmon", Id = 61, price = 225, Max = 100, sold = 0},
		        [9] = {Name = "Barracuda", Id = 62, price = 250, Max = 100, sold = 0},
		        [10] = {Name = "Tuna", Id = 63, price = 275, Max = 100, sold = 0},
		        [11] = {Name = "Yellowtail", Id = 64, price = 300, Max = 100, sold = 0},
		    }},
		},
		Vehicles ={
			Model = "tug"
