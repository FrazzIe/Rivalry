	...
	Data = {
		...
		Store = {
		    {Category = "Freshly Caught Fish", Items = {
		        ...
		        [6] = {Name = "Mackerel", Id = 59, price = 70, Max = 100, sold = 0},
		        [7] = {Name = "Herring", Id = 60, price = 80, Max = 100, sold = 0},
		        [8] = {Name = "Salmon", Id = 61, price = 90, Max = 100, sold = 0},
		        [9] = {Name = "Barracuda", Id = 62, price = 100, Max = 100, sold = 0},
		        [10] = {Name = "Tuna", Id = 63, price = 110, Max = 100, sold = 0},
		        [11] = {Name = "Yellowtail", Id = 64, price = 120, Max = 100, sold = 0},
		    }},
		},
		Vehicles ={
			Model = "tug"
