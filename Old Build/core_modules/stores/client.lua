...
Citizen.CreateThread(function()
	...
	while true do
        ...
        local PlayerPosition = GetEntityCoords(PlayerPosition, false)
...
Citizen.CreateThread(function()
	CreateBlip("You Tool", 402, 21, Tools[1].x, Tools[1].y, Tools[1].z)
	CreateBlip("Davis Mega Mall", 402, 21, Tools[2].x, Tools[2].y, Tools[2].z)
	while true do
		Citizen.Wait(0)
		local PlayerPed = PlayerPedId()
