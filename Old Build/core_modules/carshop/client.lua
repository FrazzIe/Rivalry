...
cars = {
    ...
    {title = "Sports", vehicles = {
        ...
        {name = "Elegy Retro Custom", price = 25500, model = "elegy"},
    ...
    {title = "Motorcycles", vehicles = {
        ...
        {name = "Avarus", price = 26000, model = "avarus"},
        {name = "Bagger", price = 19000, model = "bagger"},
        {name = "Bati 801", price = 15000, model = "bati"},
        {name = "Bati 801RR", price = 17000, model = "bati2"},
        {name = "BF400", price = 35000, model = "bf400"},
        {name = "Carbon RS", price = 40000, model = "carbonrs"},
        {name = "Cliffhanger", price = 45000, model = "cliffhanger"},
        {name = "Daemon", price = 35000, model = "daemon2"},
        {name = "Daemon (Lost)", price = 37000, model = "daemon"},
        ...
        {name = "FCR 1000", price = 18000, model= "fcr"},
        {name = "FCR 1000 Custom", price = 21000, model = "fcr2"},
