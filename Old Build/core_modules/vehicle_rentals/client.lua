...
rental_cars = {
    {title = "Cars", vehicles = {
        {name = "Punto", price = 400, model = "panto"},
        {name = "Alpha", price = 500, model = "alpha"},
        {name = "Banshee", price = 650, model = "banshee"},
        {name = "Buffalo", price = 400, model = "buffalo"},
        {name = "Buffalo S", price = 400, model = "buffalo2"},
        {name = "Baller", price = 400, model = "baller"},
        {name = "Cavalcade", price = 600, model = "cavalcade"},
        {name = "Grabger", price = 300, model = "granger"},
        {name = "Huntley S", price = 400, model = "huntley"},
        {name = "Landstalker", price = 1000, model = "landstalker"},
        {name = "Radius", price = 300, model = "radi"},
        {name = "Rocoto", price = 400, model = "rocoto"},
        {name = "Seminole", price = 300, model = "seminole"},
        {name = "XLS", price = 500, model = "xls"},
    }},
    {title = "Bicycles", vehicles = {
        {name = "BMX", price = 350, model = "bmx"},
        {name = "Scorcher", price = 400, model = "scorcher"},
        {name = "TriBike", price = 400, model = "tribike3"},
    }},
    {title = "Motorcycles", vehicles = {
        {name = "Faggio", price = 250, model = "faggio2"},
        {name = "Enduro", price = 700, model = "enduro"},
...
rental_boats = {
    {title = "Boats", vehicles = {
        ...
        {name = "Submarine", price = 150000, model = "submersible"},
    }},
