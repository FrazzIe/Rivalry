...
tattoosCategories = { -- more to come
    [1] = {value = "mpbusiness_overlays"},
    [2] = {value = "mphipster_overlays"},
    [3] = {value = "mpbiker_overlays"},
    [4] = {value = "mpairraces_overlays"},
    [5] = {value = "mpbeach_overlays"},
    [6] = {value = "mpchristmas2_overlays"},
    [7] = {value = "mpgunrunning_overlays"},
    [8] = {value = "mpimportexport_overlays"},
    [9] = {value = "mplowrider2_overlays"},
    [10] = {value = "mplowrider_overlays"}
}

local tattoo_shops = {
    [1] = {name="Tattoo Store", id=75, x=1322.645,y=-1651.976,z=52.275},
    [2] = {name="Tattoo Store", id=75, x=-1153.676,y=-1425.68,z=4.954},
    [3] = {name="Tattoo Store", id=75, x=322.139,y=180.467,z=103.587},
    [4] = {name="Tattoo Store", id=75, x=-3170.071,y=1075.059,z=20.829},
    [5] = {name="Tattoo Store", id=75, x=1864.633,y=3747.738,z=33.032},
    [6] = {name="Tattoo Store", id=75, x=-293.713,y=6200.04,z=31.487},
}

incircle = false
Citizen.CreateThread(function()
    for _, item in pairs(tattoo_shops) do
    ...
    while true do
        ...
        for k,v in ipairs(tattoo_shops) do
            if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 15.0)then
                ...
                if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 2.0)then
                    if (incircle == false) then
                        DisplayHelpText("Press ~INPUT_CONTEXT~ for a tattoo session.")
                    end
                    incircle = true
