...
RegisterNUICallback('emssubmit-report', function(data, cb)
	TriggerServerEvent('ems:submitreport', data.r1, data.r2, data.r3, data.r4, data.r5, data.r6, data.r7, data.r8, data.r9, data.r10, data.r11, data.r12, data.r13, data.r14, data.r15, data.r16, data.r17, data.r18 )
	cb('ok')
end)
...
RegisterNUICallback('ems-load-reports', function(data, cb)
	TriggerServerEvent('ems:loadreports', data.id)
	cb('ok')
end)

RegisterNUICallback('ems-load-report', function(data, cb)
	TriggerServerEvent('ems:loadreport', data.id)
	cb('ok')
end)
...
RegisterNUICallback('emsdoa', function(data, cb)
	TriggerServerEvent('ems:mdtdoa', data.firstname, data.lastname)
	cb('ok')
end)
--[[
=================================================================================================================================================================================================================================================
...
RegisterNetEvent('ems:loadreportss')
AddEventHandler('ems:loadreportss', function(reports)
	SendNUIMessage({openSection = "emsloadReportss", list = reports})
end)

RegisterNetEvent('ems:loadreport')
AddEventHandler('ems:loadreport', function(report)
	SendNUIMessage({openSection = "emsloadReport", r1 = report.r1, r2 = report.r2, r3 = report.r3, r4 = report.r4, r5 = report.r5, r6 = report.r6, r7 = report.r7, r8 = report.r8, r9 = report.r9, r10 = report.r10, r11 = report.r11, r12 = report.r12, r13 = report.r13, r14 = report.r14, r15 = report.r15, r16 = report.r16, r17 = report.r17, r18 = report.r18})
end)

RegisterNetEvent('ems:healthstatusupdate')
AddEventHandler('ems:healthstatusupdate', function(healthv)
	SendNUIMessage({openSection = "emsHealthStatusUpdate", health = healthv})
end)
--[[
=================================================================================================================================================================================================================================================
=================================================================================================================================================================================================================================================
