...
local charges = {
    {title="1st Degree Felonies", items = {
        ...
        {charge="Aggravated Kidnapping", time=10, cost=5000},
        {charge="Kidnapping", time=10, cost=5000},
        {charge="Aggravated Armed Robbery", time=15, cost=7500},
        {charge="Armed Bank Robbery", time=15, cost=7500},
        {charge="Grand Theft Auto", time=10, cost=5000},
        {charge="Racketeering", time=10, cost=5000},
    }},
    {title="2nd Degree Felonies", items = {
        {charge="Poss. of CDS w/ Intent to Dist. (Weed/Cannabis 11-19)", time=10, cost=2500},
        {charge="Poss. of CDS w/ Intent to Dist. (Weed/Cannabis 20-59)", time=10, cost=5000},
        {charge="Poss. of CDS w/ Intent to Dist. (Weed/Cannabis 60-119)", time=10, cost=7500},
        {charge="Poss. of CDS w/ Intent to Dist. (Weed/Cannabis 120+)", time=10, cost=10000},
        {charge="Poss. of CDS w/ Intent to Dist. (Cocaine 1-30)", time=10, cost=5000},
        {charge="Poss. of CDS w/ Intent to Dist. (Cocaine 31-59)", time=10, cost=7500},
        {charge="Poss. of CDS w/ Intent to Dist. (Cocaine 60-119)", time=10, cost=10000},
        {charge="Poss. of CDS w/ Intent to Dist. (Cocaine 120+)", time=10, cost=12500},
        {charge="Drug Trafficking (CDS in vehicle)", time=10, cost=2500},
        {charge="Sale of CDS", time=5, cost=750},
        {charge="Manslaughter", time=10, cost=2500},
        {charge="Negligent Homicide", time=10, cost=2500},
        {charge="Vehicular Manslaughter", time=10, cost=2500},
        {charge="Attempted Kidnapping", time=10, cost=2500},
        {charge="Felonious Restraint", time=10, cost=500},
        {charge="Grand Theft", time=10, cost=2500},
        {charge="Robbery", time=10, cost=2500},
        {charge="Petty Theft with Prior", time=5, cost=2500},
        {charge="Petty Theft", time=5, cost=2500},
        {charge="Escape While Armed", time=5, cost=2500},
    }},
    {title="3rd Degree Felonies", items = {
        {charge="Aiding and Abetting | Felony", time=10, cost=5000},
        {charge="Aggravated Assault", time=10, cost=2500},
        {charge="Hit and Run With Injuries", time=10, cost=2500},
        {charge="Felony Evading Law Enforcement (Vehicle)", time=10, cost=5000},
        {charge="Felony Evading Causing Death/Injury (Vehicle)", time=15, cost=7500},
        {charge="Poss. of Class 2 Illegal Firearm/Weapon", time=10, cost=2500},
        {charge="Illegal Sale/Transfer of Class 2 Firearm(s)", time=10, cost=2500},
        {charge="Poss. of Firearm by Convicted Violent Felon", time=10, cost=2500},
        {charge="Identity Theft by a Convicted Felon", time=5, cost=2500},
        {charge="Attempted or Unarmed Robbery", time=10, cost=2500},
        {charge="Perjury", time=5, cost=2500},
        {charge="Attempted Bribery", time=5, cost=2500},
        {charge="Escape", time=5, cost=2500},
        {charge="Rioting", time=5, cost=2500},
        {charge="DUI/DWI", time=5, cost=2500},
    }},
    {title="1st Degree Misdemeanors", items = {
        ...
        {charge="Attempted Grand Theft Auto", time=5, cost=2500},
        ...
        {charge="Fleeing/Eluding Law Enforcement (On Foot)", time=10, cost=2500},
    ...
    {title="2nd Degree Misdemeanors", items = {
        ...
        {charge="Poss. of Stolen Vehicle", time=5, cost=2500},
        {charge="Poss. of Counterfeit Currency", time=5, cost=1500},
        {charge="Damage to Public Property", time=5, cost=1500},
        {charge="Damage to Private Property", time=5, cost=1500},
    ...
    {title="3rd Degree Misdemeanors", items = {
        ...
        {charge="Resisting Arrest", time=10, cost=1000},
        ...
        {charge="Disorderly Conduct", time=5, cost=1250},
        {charge="Poss. of Firearm w/o a Weapons License", time=10, cost=1500},
    ...
    {title="Traffic Violations", items = {
        ...
        {charge="Speeding 30mph+ Over", time=0, cost=2000},
        {charge="Unroadworthy Vehicle", time=0, cost=1000},
        {charge="Careless Driving", time=0, cost=2500},
        {charge="Illegal U-turn", time=0, cost=250},
        {charge="Illegal Window Tint", time=0, cost=250},
        {charge="Fail to Yield to Emergency Services", time=0, cost=1000},
        {charge="No insurance/Expired Registration", time=0, cost=250},
        {charge="Fail to Give Right of Way", time=0, cost=250},
        ...
        {charge="Wrong Way", time=0, cost=250},
