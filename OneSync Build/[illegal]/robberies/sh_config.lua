Config = {
	...
	Robberies = {
		...
		},
		{
			...
			Robbables = {
				"Doors",
				{ Id = "Keypad", Required = true, Coords = { vector4(-105.6590423584, 6471.8740234375, 31.626710891724, 44.672233581543) }, Unlocks = { vector3(-104.60489654541, 6473.4438476563, 31.795324325562) }, Opens = true },
				{ Id = "Lockbox", Coords = {
