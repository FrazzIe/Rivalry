    ...
    while true do
      Citizen.Wait(0)
        if inService then
            ...
            local CurrentMissionVector = vector3(missionXCoord, missionYCoord, missionZCoord)
            local PreviousMissionVector = vector3(previousMissionX, previousMissionY, previousMissionZ)
