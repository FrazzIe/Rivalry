...
$(document).ready(function(){
  ...
  document.onkeyup = function (data) {
    if (data.which == 27 ) {
      $.post('http://others-banking/close', JSON.stringify({}));
    }
  };
  // Handle Button Presses
  $(".btnWithdraw").click(function(){
      $.post('http://others-banking/withdraw', JSON.stringify({}));
  });
  $(".btnDeposit").click(function(){
      $.post('http://others-banking/deposit', JSON.stringify({}));
  });
  $(".btnTransfer").click(function(){
      $.post('http://others-banking/transfer', JSON.stringify({}));
  });
  $(".btnBalance").click(function(){
      $.post('http://others-banking/balance', JSON.stringify({}));
  });
  $('.btnQuick').click($.throttle( 2000, true, function(e){
    $.post('http://others-banking/quickCash', JSON.stringify({}));
  }));
  ...
  $("#withdraw-form").submit(function(e) {
      e.preventDefault();
      $.post('http://others-banking/withdrawSubmit', JSON.stringify({
  ...
  $("#deposit-form").submit(function(e) {
      e.preventDefault();
      $.post('http://others-banking/depositSubmit', JSON.stringify({
  ...
  $("#transfer-form").submit(function(e) {
      e.preventDefault();
      $.post('http://others-banking/transferSubmit', JSON.stringify({
