									...
									if Cocaine.Cooldown > 0 then
										...
										if IsControlJustPressed(1, 51) then
											...
											if willNPCbuy() then
												...
												TaskPlayAnim(PlayerPed, "mp_safehousevagos@", "package_dropoff", 100.0, 200.0, 0.3, 16, 0.2, 0, 0, 0)
											...
											elseif math.random() < 0.5 then
												...
												ClearPedTasksImmediately(ped)
												TaskPlayAnim(ped, "gestures@m@standing@casual", "gesture_nod_no_hard", 100.0, 200.0, 0.3, 16, 0.2, 0, 0, 0)
