...
Citizen.CreateThread(function()
    local CameraList = {
        ...
        {Text = " - 17 | Downtown Vinewood | Interior Camera", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 18 | Downtown Vinewood | Exterior Camera", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 19 | Banham Canyon | Interior Camera", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 20 | Banham Canyon | Exterior Camera", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 21 | Harmony | Interior Camera", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 22 | Harmony | Exterior Camera", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 23 | Senora Fwy | Interior Camera", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 24 | Senora Fwy | Exterior Camera", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 25 | Fleeca Bank | Hawick Ave | Interior Camera", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 26 | Fleeca Bank | Hawick Ave | Exterior Camera", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 27 | Fleeca Bank | Great Ocean Hwy | Interior Camera", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 28 | Fleeca Bank | Great Ocean Hwy | Exterior Camera", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 29 | Fleeca Bank | Route 68 | Interior Camera", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 30 | Fleeca Bank | Route 68 | Exterior Camera", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 31 | Blaine County Savings | Interior Camera", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 32 | Blaine County Savings | Exterior Camera", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 33 | Pacific Standard | Flr 2 Stairwell", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 34 | Pacific Standard | Flr 2 Balcony", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 35 | Pacific Standard | Flr 2 Stairs", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 36 | Pacific Standard | Flr 1 Lobby", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 37 | Pacific Standard | Vault Door", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 38 | Pacific Standard | Flr 2 Offices", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 39 | Pacific Standard | Back Alley", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 40 | Pacific Standard | Front Door", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 41 | Jewelry Store | Interior Camera 1", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 42 | Jewelry Store | Interior Camera 2", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
        {Text = " - 43 | Jewelry Store | Interior Camera 3", Scale = 0.3, Font = 6, R = 255, G = 255, B = 255, A = 255},
    }
    local X, Y = 0, 0.25
    while true do
        Citizen.Wait(0)
