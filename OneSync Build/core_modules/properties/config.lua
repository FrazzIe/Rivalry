...
properties = {
	houses = {
		normal = {
			...
			[118] = {
				...
				owner =  {
					...
					id = 0, --Default (don't touch)
              			...
              			coordinates = vector3(-1629.6062011719,36.828025817871,62.936130523682), -- The location of the property
				rent = 2000, --How much it costs to rent the property (PER DAY)
				storage = {
					current = {
						cash = 0, --Default (don't touch)
			...
			[119] = {
				property_name = "420 Buen Vino Road", -- Name of the property (used as the title of the menu)
				locked = false, --Default (don't touch)
				owner =  {
					identifier = "no", --Default (don't touch)
					char_id = 0, --Default (don't touch)
					id = 0, --Default (don't touch)
              			...
              			coordinates = vector3(-1888.162109375,2049.7333984375,140.98307800293), -- The location of the property
				rent = 5000, --How much it costs to rent the property (PER DAY)
				storage = {
					current = {
						cash = 0, --Default (don't touch)
