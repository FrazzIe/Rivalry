...
emplacement_garage = {
    [1] = {name="Public Garage", colour=1, sprite=357, x = -333.53753662109, y = -779.95513916016, z = 33.965061187744,id=1,gname="Peaceful St [1]",cost=3000,heading=127.01721191406,maxslots=5}, -- Peaceful St
    [2] = {name="Public Garage", colour=1, sprite=357, x=-443.00497436523,y=185.29835510254,z=75.203712463379,id=2,gname="North LS [2]",cost=2000,heading=0.0,maxslots=4}, -- Public Upper City
    [3] = {name="Public Garage", colour=1, sprite=357, x=1232.4792480469,y=2708.3212890625,z=38.005790710449,id=3,gname="Sandy [3]",cost=1000,heading=0.0,maxslots=3}, -- Public Sandy
    [4] = {name="Public Garage", colour=1, sprite=357, x=117.96788024902,y=6599.45703125,z=32.013603210449,id=4,gname="Paleto [4]",cost=1000,heading=-90.0,maxslots=3}, -- Public Paleto
    [5] = {name="Personal Garage", colour=3, sprite=357, x=947.13641357422,y=-1697.9788818359,z=30.085023880005,id=5,gname="Industrial [5]",cost=2000,heading=-95.0,maxslots=4}, -- Personal
    [6] = {name="Personal Garage", colour=3, sprite=357, x=520.40753173828,y=168.9965057373,z=99.372108459473,id=6,gname="Apartment Complex [6]",cost=2000,heading=-110.0,maxslots=3}, -- Personal
    [7] = {name="Personal Garage", colour=3, sprite=357, x=-667.74456787109,y=-2378.0485839844,z=13.8580493927,id=7,gname="Exceptionalists Way [7]",cost=4000,heading=-45.0,maxslots=5}, -- Personal
    [8] = {name="Personal Garage", colour=3, sprite=357, x=258.68347167969,y=2589.7287597656,z=44.954097747803,id=8,gname="Autoshop Garage [8]",cost=2000,heading=10.0,maxslots=3}, -- Personal
    [9] = {name="Personal Garage", colour=3, sprite=357, x=-34.561923980713,y=6418.0092773438,z=31.442190170288,id=9,gname="Paleto Blvd [9]",cost=2000,heading=225.0,maxslots=3}, -- Personal
    [10] = {name="Personal Garage", colour=3, sprite=357, x=-833.24926757813,y=-392.95385742188,z=31.325246810913,id=10,gname="Weazel [10]",cost=4000,heading=225.0,maxslots=6}, -- Personal
    [11] = {name="Personal Garage", colour=3, sprite=357, x=-30.303638458252,y=2.1268248558044,z=71.200004577637,id=11,gname="Small Garage [11]",cost=2000,heading=150.0,maxslots=3}, -- Personal
    [12] = {name="Personal Garage", colour=3, sprite=357, x=-84.019691467285,y=-820.99694824219,z=36.028030395508,id=12,gname="Maze Tower [12]",cost=5000,heading=-365.0,maxslots=7}, -- Personal
    [13] = {name="Personal Garage", colour=3, sprite=357, x=1958.3830566406,y=3767.013671875,z=32.208053619385,id=13,gname="Sandy Shores [13]",cost=3000,heading=29.273107528687,maxslots=4}, -- Personal
    [14] = {name="Public Garage", colour=1, sprite=357, x=379.36770629883,y=-1678.8072509766,z=27.309490203857,id=14,gname="Rancho [14]",cost=3000,heading=227.73773193359,maxslots=5}, -- Rancho
	[15] = {name="Personal Garage", colour=3, sprite=357, x=324.15,y=-684.08,z=29.31,id=15,gname="Integrity [15]",cost=3000,heading=250.24,maxslots=3}, -- Personal
}
