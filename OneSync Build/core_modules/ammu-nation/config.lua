...
Weapons = {
	{Category = "Pistols", License = true, Items = {
		...
		{Weapon = "WEAPON_VINTAGEPISTOL", Name = "Vintage Pistol", Cost = 1000},
	...
	{Category = "Melee", License = false, Items = {
		{Weapon = "WEAPON_KNIFE", Name = "Knife", Cost = 100},
		{Weapon = "WEAPON_FLASHLIGHT", Name = "Flashlight", Cost = 100},
		--{Weapon = "WEAPON_NIGHTSTICK", Name = "Nightstick", Cost = 100},
		{Weapon = "WEAPON_HAMMER", Name = "Hammer", Cost = 75},
		{Weapon = "WEAPON_BAT", Name = "Baseball Bat", Cost = 150},
		{Weapon = "WEAPON_GOLFCLUB", Name = "Golfclub", Cost = 150},
		{Weapon = "WEAPON_CROWBAR", Name = "Crowbar", Cost = 150},
		{Weapon = "WEAPON_BOTTLE", Name = "Smashed Bottle", Cost = 75},
		{Weapon = "WEAPON_DAGGER", Name = "Dagger", Cost = 75},
		--{Weapon = "WEAPON_KNUCKLE", Name = "Knuckle Dusters", Cost = 500},
		{Weapon = "WEAPON_HATCHET", Name = "Hatchet", Cost = 75},
		{Weapon = "WEAPON_MACHETE", Name = "Machete", Cost = 150},
		{Weapon = "WEAPON_SWITCHBLADE", Name = "Switchblade", Cost = 150},
		{Weapon = "WEAPON_BATTLEAXE", Name = "Battleaxe", Cost = 150},
		{Weapon = "WEAPON_POOLCUE", Name = "Poolcue", Cost = 100},
		{Weapon = "WEAPON_WRENCH", Name = "Wrench", Cost = 100},
	}},
	{Category = "Shotguns", License = true, Items = {
		--{Weapon = "WEAPON_SAWNOFFSHOTGUN", Name = "Sawed-Off Shotgun", Cost = 1},
		{Weapon = "WEAPON_DBSHOTGUN", Name = "Double Barrel Shotgun", Cost = 1750},
...
Blackmarket_Weapons = {
	{Category = "Pistols", Items = {
		{Weapon = "WEAPON_PISTOL", Name = "Pistol", Cost = 750, AmmoType = "9mm", Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_COMBATPISTOL", Name = "Combat Pistol", Cost = 1000, AmmoType = ".45mm", Gang = "all", SecondaryGang = "none"},
		...
		{Weapon = "WEAPON_SNSPISTOL", Name = "SNS Pistol", Cost = 1000, AmmoType = ".45mm", Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_APPISTOL", Name = "AP Pistol", Cost = 2500, AmmoType = "9mm", Gang = "russian", SecondaryGang = "italian"},
	...
	{Category = "Submachine guns", Items = {
		{Weapon = "WEAPON_MINISMG", Name = "Mini SMG", Cost = 1500, AmmoType = "9mm", Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_MACHINEPISTOL", Name = "Machine Pistol", Cost = 1250, AmmoType = "9mm", Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_COMBATPDW", Name = "Combat PDW", Cost = 2250, AmmoType = "5.56mm", Gang = "italian", SecondaryGang = "russian"},
		{Weapon = "WEAPON_MICROSMG", Name = "Micro SMG", Cost = 2000, AmmoType = ".45mm", Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_SMG", Name = "MP5", Cost = 2500, AmmoType = "5.56mm", Gang = "italian", SecondaryGang = "russian"},
		{Weapon = "WEAPON_ASSAULTSMG", Name = "Assault SMG", Cost = 2250, AmmoType = "5.56mm", Gang = "russian", SecondaryGang = "none"},
		{Weapon = "WEAPON_GUSENBERG", Name = "Gusenberg Sweeper", Cost = 2250, AmmoType = ".45mm", Gang = "italian", SecondaryGang = "none"},
		{Weapon = "WEAPON_MG", Name = "MG", Cost = 5000, AmmoType = "7.62mm", Gang = "russian", SecondaryGang = "none"},
	}},
	{Category = "Assault Rifles", Items = {
		{Weapon = "WEAPON_COMPACTRIFLE", Name = "Compact Rifle", Cost = 2500, AmmoType = "7.62mm", Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_ADVANCEDRIFLE", Name = "Advanced Rifle", Cost = 2500, AmmoType = "5.56mm", Gang = "russian", SecondaryGang = "none"},
		{Weapon = "WEAPON_ASSAULTRIFLE", Name = "Assault Rifle", Cost = 3000, AmmoType = "7.62mm", Gang = "russian", SecondaryGang = "italian"},
	...
	{Category = "Melee", Items = {
		{Weapon = "WEAPON_KNIFE", Name = "Knife", Cost = 100, Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_FLASHLIGHT", Name = "Flashlight", Cost = 100, Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_NIGHTSTICK", Name = "Nightstick", Cost = 1000, Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_HAMMER", Name = "Hammer", Cost = 100, Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_BAT", Name = "Baseball Bat", Cost = 150, Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_GOLFCLUB", Name = "Golfclub", Cost = 150, Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_CROWBAR", Name = "Crowbar", Cost = 150, Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_BOTTLE", Name = "Smashed Bottle", Cost = 75, Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_DAGGER", Name = "Dagger", Cost = 75, Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_KNUCKLE", Name = "Knuckle Dusters", Cost = 150, Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_HATCHET", Name = "Hatchet", Cost = 75, Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_MACHETE", Name = "Machete", Cost = 150, Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_SWITCHBLADE", Name = "Switchblade", Cost = 150, Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_BATTLEAXE", Name = "Battleaxe", Cost = 150, Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_POOLCUE", Name = "Poolcue", Cost = 100, Gang = "all", SecondaryGang = "none"},
		{Weapon = "WEAPON_WRENCH", Name = "Wrench", Cost = 100, Gang = "all", SecondaryGang = "none"},
	}},
	{Category = "Shotguns", Items = {
		{Weapon = "WEAPON_SAWNOFFSHOTGUN", Name = "Sawed-Off Shotgun", Cost = 1000, AmmoType = "12g", Gang = "ballers", SecondaryGang = "none"},
		{Weapon = "WEAPON_DBSHOTGUN", Name = "Double Barrel Shotgun", Cost = 1000, AmmoType = "12g", Gang = "ballers", SecondaryGang = "italian"},
		{Weapon = "WEAPON_PUMPSHOTGUN", Name = "Pump Shotgun", Cost = 1250, AmmoType = "12g", Gang = "italian", SecondaryGang = "russian"},
		{Weapon = "WEAPON_BULLPUPSHOTGUN", Name = "Bullpup Shotgun", Cost = 1250, AmmoType = "11g", Gang = "italian", SecondaryGang = "none"},
		{Weapon = "WEAPON_HEAVYSHOTGUN", Name = "Heavy Shotgun", Cost = 1500, AmmoType = "12g", Gang = "italian", SecondaryGang = "none"},
	}},
...
Public_Blackmarket_Weapons = {
	{Category = "Pistols", Items = {
		{Weapon = "WEAPON_PISTOL", Name = "Pistol", Cost = 750},
		{Weapon = "WEAPON_COMBATPISTOL", Name = "Combat Pistol", Cost = 1000},
		{Weapon = "WEAPON_VINTAGEPISTOL", Name = "Vintage Pistol", Cost = 750},
	...
	{Category = "Shotguns", Items = {
		{Weapon = "WEAPON_DBSHOTGUN", Name = "Double Barrel Shotgun", Cost = 1500},
	}},
