function closures_mechanic_server()
    ...
    local preFixEventName = 'mechanic'
    ...
    AddEventHandler("getMechs", function(cb)
        cb(getNbPerosnnelActive())
    end)
end


RegisterServerEvent('mechanic:quickRepair')
AddEventHandler('mechanic:quickRepair', function(vehicle)
    TriggerClientEvent("mechanic:qrepair", vehicle)
end)
RegisterServerEvent('mechanic:completeRepair')
AddEventHandler('mechanic:completeRepair', function(vehicle)
    TriggerClientEvent("mechanic:cRepair", vehicle)
end)

RegisterServerEvent('Mechanic:setService')
AddEventHandler('Mechanic:setService', function (inService)
    TriggerEvent('core:getuser', source , function (Player)
        Player.setSessionVar('MechanicInService', inService)
    end)
end)

closures_mechanic_server()