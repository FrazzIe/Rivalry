Utilities.Data.Weapons = {
	...
	Labels = {
		...
		["WEAPON_ANIMAL"] = "0x02E84420",
		["WEAPON_COUGAR"] = "0x02E84420",
		["WEAPON_PASSENGER_ROCKET"] = "DIED_IN_EXPLOSION",
		["WEAPON_AIRSTRIKE_ROCKET"] = "DIED_IN_EXPLOSION",
		["WEAPON_BRIEFCASE"] = "DIED_IN_FALL",
		["WEAPON_BRIEFCASE_02"] = "DIED_IN_FALL",
		["WEAPON_VEHICLE_ROCKET"] = "DIED_IN_EXPLOSION",
		["WEAPON_BARBED_WIRE"] = "FMMC_PR_FNCBWSG",
		["WEAPON_DROWNING"] = "DIED_IN_DROWNING",
		["WEAPON_DROWNING_IN_VEHICLE"] = "DIED_IN_DROWNING",
		["WEAPON_BLEEDING"] = "FMMC_VEHW_EX",
		["WEAPON_EXPLOSION"] = "DIED_IN_EXPLOSION",
		["WEAPON_FALL"] = "DIED_IN_FALL",
		["WEAPON_EXHAUSTION"] = "FMMC_VEHW_EX",
		["WEAPON_HIT_BY_WATER_CANNON"] = "WT_IMPACT",
		["WEAPON_RAMMED_BY_CAR"] = "DIED_IN_ROAD",
		["WEAPON_RUN_OVER_BY_CAR"] = "DIED_IN_ROAD",
		["WEAPON_HELI_CRASH"] = "DIED_IN_ROAD",
		["WEAPON_FIRE"] = "DIED_IN_FIRE",
...
function Utilities:GetWeaponHash(Weapon)
	if self.Data.Weapons.Hashes[Weapon] then
		return self.Data.Weapons.Hashes[Weapon]
	else
		return nil
	end
end

function Utilities:GetWeaponCollision(Hash)
	if self.Data.Weapons.Collisions[Hash] then
		return self.Data.Weapons.Collisions[Hash]
	else
		return nil
	end
end

function Utilities:GetWeaponTints(Weapon)
	if string.find(Weapon, "_MK2") then
...
function Utilities:GetWeaponAttachments(Weapon)
	if self.Data.Weapons.Attachments[Weapon] then
		return self.Data.Weapons.Attachments[Weapon]
	else
		return nil
	end
end