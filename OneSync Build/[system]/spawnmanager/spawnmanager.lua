...
AddEventHandler("paramedic:coma", function()
    playerInComa = true
end)
...
local function freezePlayer(id, freeze)
    ...
    if not freeze then
        if not IsEntityVisible(ped) then
            exports.core_modules:setAttribute("invisible", false)
        ...
        exports.core_modules:setAttribute("invincible", false)
        SetPlayerInvincible(player, false)
    else
        if IsEntityVisible(ped) then
           exports.core_modules:setAttribute("invisible", true)
           Citizen.Wait(5)
        ...
        exports.core_modules:setAttribute("invincible", true)
        Citizen.Wait(5)
