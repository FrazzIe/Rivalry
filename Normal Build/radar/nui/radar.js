...
$( function() {
    ...
    window.addEventListener( 'message', function( event ) {
        ...
        if(item.fwdplate) {
            $("#fwdplate").text(item.fwdplate)
        }

        if(item.bwdplate) {
            $("#bwdplate").text(item.bwdplate)
        }

        if(item.fwdfastplate) {
            $("#fwdfastplate").text(item.fwdfastplate)
        }

        if(item.bwdfastplate) {
            $("#bwdfastplate").text(item.bwdfastplate)
        }

        if(item.patrolplate) {
            $("#patrolplate").text(item.patrolplate)
        }
    } );
} )
