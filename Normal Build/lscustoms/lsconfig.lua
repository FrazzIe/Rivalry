...
local lightcolors = {
	{name = "Default", colorindex = -1},
	{name = "White", colorindex = 0},
	{name = "Blue", colorindex = 1},
	{name = "Electric Blue", colorindex = 2},
	{name = "Mint Green", colorindex = 3},
	{name = "Lime Green", colorindex = 4},
	{name = "Yellow", colorindex = 5},
	{name = "Golden Shower", colorindex = 6},
	{name = "Orange", colorindex = 7},
	{name = "Red", colorindex = 8},
	{name = "Pony Pink", colorindex = 9},
	{name = "Hot Pink", colorindex = 10},
	{name = "Purple", colorindex = 11},
	{name = "Backlight", colorindex = 12},
}
