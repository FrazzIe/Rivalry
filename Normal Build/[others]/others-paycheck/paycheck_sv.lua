PayCheck = {
	...
	EMS = {
		...
		[2] = {Rank = "assistant chief", Pay = 1000},
		[3] = {Rank = "captain", Pay = 900},
		[4] = {Rank = "lieutenant", Pay = 800},
		[5] = {Rank = "specialist", Pay = 700},
		[6] = {Rank = "doctor", Pay = 600},
		[7] = {Rank = "coroner", Pay = 500},
		[8] = {Rank = "paramedic", Pay = 400},
		[9] = {Rank = "probationary", Pay = 250},
	},
	DOJ = {
		[1] = {Rank = "chief justice", Pay = 2000},
		[2] = {Rank = "justice", Pay = 1250},
		[3] = {Rank = "judge", Pay = 1000},
