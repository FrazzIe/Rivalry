...
Citizen.CreateThread(function()
    while true do
        ...
        if DoesEntityExist( ped ) and not IsEntityDead( ped ) and not IsPedInAnyVehicle(PlayerPedId(), true) and not IsPedInParachuteFreeFall( ped ) and GetPedParachuteState(ped) < 1 and not IsPedFalling(ped) then
