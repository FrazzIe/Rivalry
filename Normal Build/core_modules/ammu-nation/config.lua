...
ammu_nation = {
	...
	blackmarket = {
		{name="Black Market", colour=4, id=110, x = 1024.017578125, y = -3111.3796386719, z = -38.999870300293},
	},
	license = {
...
Blackmarket_Weapons = {
	{Category = "Pistols", Items = {
		{Weapon = "WEAPON_PISTOL", Name = "Pistol", Cost = 1, AmmoType = "9mm"},
		{Weapon = "WEAPON_COMBATPISTOL", Name = "Combat Pistol", Cost = 1, AmmoType = ".45mm"},
		{Weapon = "WEAPON_PISTOL50", Name = "Pistol .50", Cost = 1, AmmoType = ".50mm"},
		{Weapon = "WEAPON_HEAVYPISTOL", Name = "Heavy Pistol", Cost = 1, AmmoType = ".45mm"},
		{Weapon = "WEAPON_SNSPISTOL", Name = "SNS Pistol", Cost = 1, AmmoType = ".45mm"},
		{Weapon = "WEAPON_APPISTOL", Name = "AP Pistol", Cost = 1, AmmoType = "9mm"},
		{Weapon = "WEAPON_VINTAGEPISTOL", Name = "Vintage Pistol", Cost = 1, AmmoType = "9mm"},
		{Weapon = "WEAPON_REVOLVER", Name = "Revolver", Cost = 1, AmmoType = ".44mm"},
	}},
	{Category = "Submachine guns", Items = {
		{Weapon = "WEAPON_MINISMG", Name = "Mini SMG", Cost = 1, AmmoType = "9mm"},
		{Weapon = "WEAPON_MACHINEPISTOL", Name = "Machine Pistol", Cost = 1, AmmoType = "9mm"},
		{Weapon = "WEAPON_COMBATPDW", Name = "Combat PDW", Cost = 1, AmmoType = "5.56mm"},
		{Weapon = "WEAPON_MICROSMG", Name = "Micro SMG", Cost = 1, AmmoType = ".45mm"},
		{Weapon = "WEAPON_SMG", Name = "MP5", Cost = 1, AmmoType = "5.56mm"},
		{Weapon = "WEAPON_ASSAULTSMG", Name = "Assault SMG", Cost = 1, AmmoType = "5.56mm"},
		{Weapon = "WEAPON_GUSENBERG", Name = "Gusenberg Sweeper", Cost = 1, AmmoType = ".45mm"},
		{Weapon = "WEAPON_MG", Name = "MG", Cost = 1, AmmoType = "7.62mm"},
	}},
	{Category = "Assault Rifles", Items = {
		{Weapon = "WEAPON_COMPACTRIFLE", Name = "Compact Rifle", Cost = 1, AmmoType = "7.62mm"},
		{Weapon = "WEAPON_ADVANCEDRIFLE", Name = "Advanced Rifle", Cost = 1, AmmoType = "5.56mm"},
		{Weapon = "WEAPON_ASSAULTRIFLE", Name = "Assault Rifle", Cost = 1, AmmoType = "7.62mm"},
		{Weapon = "WEAPON_BULLPUPRIFLE", Name = "Bullpup Rifle", Cost = 1, AmmoType = "5.56mm"},
	}},
	{Category = "Snipers", Items = {
		{Weapon = "WEAPON_SNIPERRIFLE", Name = "Sniper Rifle", Cost = 1, AmmoType = "7.62mm"},
		{Weapon = "WEAPON_MARKSMANRIFLE", Name = "Marksman Rifle", Cost = 1, AmmoType = "7.62mm"},
	}},
	{Category = "Melee", Items = {
		{Weapon = "WEAPON_KNIFE", Name = "Knife", Cost = 1},
		{Weapon = "WEAPON_FLASHLIGHT", Name = "Flashlight", Cost = 1},
		{Weapon = "WEAPON_NIGHTSTICK", Name = "Nightstick", Cost = 1},
		{Weapon = "WEAPON_HAMMER", Name = "Hammer", Cost = 1},
		{Weapon = "WEAPON_BAT", Name = "Baseball Bat", Cost = 1},
		{Weapon = "WEAPON_GOLFCLUB", Name = "Golfclub", Cost = 1},
		{Weapon = "WEAPON_CROWBAR", Name = "Crowbar", Cost = 1},
		{Weapon = "WEAPON_BOTTLE", Name = "Smashed Bottle", Cost = 1},
		{Weapon = "WEAPON_DAGGER", Name = "Dagger", Cost = 1},
		{Weapon = "WEAPON_KNUCKLE", Name = "Knuckle Dusters", Cost = 1},
		{Weapon = "WEAPON_HATCHET", Name = "Hatchet", Cost = 1},
		{Weapon = "WEAPON_MACHETE", Name = "Machete", Cost = 1},
		{Weapon = "WEAPON_SWITCHBLADE", Name = "Switchblade", Cost = 1},
		{Weapon = "WEAPON_BATTLEAXE", Name = "Battleaxe", Cost = 1},
		{Weapon = "WEAPON_POOLCUE", Name = "Poolcue", Cost = 1},
		{Weapon = "WEAPON_WRENCH", Name = "Wrench", Cost = 1},
	}},
	{Category = "Shotguns", Items = {
		{Weapon = "WEAPON_SAWNOFFSHOTGUN", Name = "Sawed-Off Shotgun", Cost = 1, AmmoType = "12g"},
		{Weapon = "WEAPON_DBSHOTGUN", Name = "Double Barrel Shotgun", Cost = 1, AmmoType = "12g"},
		{Weapon = "WEAPON_PUMPSHOTGUN", Name = "Pump Shotgun", Cost = 1, AmmoType = "12g"},
		{Weapon = "WEAPON_BULLPUPSHOTGUN", Name = "Bullpup Shotgun", Cost = 1, AmmoType = "11g"},
		{Weapon = "WEAPON_HEAVYSHOTGUN", Name = "Heavy Shotgun", Cost = 1, AmmoType = "12g"},
	}},
	{Category = "Illegal", Items = {
        {Name = "Lockpick", Id=36, Cost = 1, Max = 10},
        {Name = "Hotwire kit", Id=46, Cost = 1, Max = 5},
        {Name = "Body Armor", Id=39, Cost = 1, Max = 51},
        {Name = "Ammo Box | 9mm", Id=83, Cost = 1, Max = 51},
        {Name = "Ammo Box | .45mm", Id=84, Cost = 1, Max = 51},
        {Name = "Ammo Box | .50mm", Id=85, Cost = 1, Max = 51},
        {Name = "Ammo Box | 5.56mm", Id=86, Cost = 1, Max = 51},
        {Name = "Ammo Box | 7.62mm", Id=87, Cost = 1, Max = 51},
        {Name = "Ammo Box | .44mm", Id=88, Cost = 1, Max = 51},
        {Name = "Ammo Box | 12g", Id=89, Cost = 1, Max = 51},
        {Name = "Ammo Box | 11g", Id=90, Cost = 1, Max = 51},
