...
ammu_nation = {
	...
	blackmarket = {
		{name="Black Market", colour=4, id=110, x=1067.7310791016, y=-3104.767578125, z=-38.999946594238},
	},
	license = {
...
Blackmarket_Weapons = {
	{Category = "Pistols", Items = {
		{Weapon = "WEAPON_PISTOL", Name = "Pistol", Cost = 0, AmmoType = "9mm"},
		{Weapon = "WEAPON_COMBATPISTOL", Name = "Combat Pistol", Cost = 0, AmmoType = ".45mm"},
		{Weapon = "WEAPON_PISTOL50", Name = "Pistol .50", Cost = 0, AmmoType = ".50mm"},
		{Weapon = "WEAPON_HEAVYPISTOL", Name = "Heavy Pistol", Cost = 0, AmmoType = ".45mm"},
		{Weapon = "WEAPON_SNSPISTOL", Name = "SNS Pistol", Cost = 0, AmmoType = ".45mm"},
		{Weapon = "WEAPON_APPISTOL", Name = "AP Pistol", Cost = 0, AmmoType = "9mm"},
		{Weapon = "WEAPON_VINTAGEPISTOL", Name = "Vintage Pistol", Cost = 0, AmmoType = "9mm"},
		{Weapon = "WEAPON_REVOLVER", Name = "Revolver", Cost = 0, AmmoType = ".44mm"},
	}},
	{Category = "Submachine guns", Items = {
		{Weapon = "WEAPON_MINISMG", Name = "Mini SMG", Cost = 0, AmmoType = "9mm"},
		{Weapon = "WEAPON_MACHINEPISTOL", Name = "Machine Pistol", Cost = 0, AmmoType = "9mm"},
		{Weapon = "WEAPON_COMBATPDW", Name = "Combat PDW", Cost = 0, AmmoType = "5.56mm"},
		{Weapon = "WEAPON_MICROSMG", Name = "Micro SMG", Cost = 0, AmmoType = ".45mm"},
		{Weapon = "WEAPON_SMG", Name = "MP5", Cost = 0, AmmoType = "5.56mm"},
		{Weapon = "WEAPON_ASSAULTSMG", Name = "Assault SMG", Cost = 0, AmmoType = "5.56mm"},
		{Weapon = "WEAPON_GUSENBERG", Name = "Gusenberg Sweeper", Cost = 0, AmmoType = ".45mm"},
		{Weapon = "WEAPON_MG", Name = "MG", Cost = 0, AmmoType = "7.62mm"},
	}},
	{Category = "Assault Rifles", Items = {
		{Weapon = "WEAPON_COMPACTRIFLE", Name = "Compact Rifle", Cost = 0, AmmoType = "7.62mm"},
		{Weapon = "WEAPON_ADVANCEDRIFLE", Name = "Advanced Rifle", Cost = 0, AmmoType = "5.56mm"},
		{Weapon = "WEAPON_ASSAULTRIFLE", Name = "Assault Rifle", Cost = 0, AmmoType = "7.62mm"},
		{Weapon = "WEAPON_BULLPUPRIFLE", Name = "Bullpup Rifle", Cost = 0, AmmoType = "5.56mm"},
	}},
	{Category = "Snipers", Items = {
		{Weapon = "WEAPON_SNIPERRIFLE", Name = "Sniper Rifle", Cost = 0, AmmoType = "7.62mm"},
		{Weapon = "WEAPON_MARKSMANRIFLE", Name = "Marksman Rifle", Cost = 0, AmmoType = "7.62mm"},
	}},
	{Category = "Melee", Items = {
		{Weapon = "WEAPON_KNIFE", Name = "Knife", Cost = 0},
		{Weapon = "WEAPON_FLASHLIGHT", Name = "Flashlight", Cost = 0},
		{Weapon = "WEAPON_NIGHTSTICK", Name = "Nightstick", Cost = 0},
		{Weapon = "WEAPON_HAMMER", Name = "Hammer", Cost = 0},
		{Weapon = "WEAPON_BAT", Name = "Baseball Bat", Cost = 0},
		{Weapon = "WEAPON_GOLFCLUB", Name = "Golfclub", Cost = 0},
		{Weapon = "WEAPON_CROWBAR", Name = "Crowbar", Cost = 0},
		{Weapon = "WEAPON_BOTTLE", Name = "Smashed Bottle", Cost = 0},
		{Weapon = "WEAPON_DAGGER", Name = "Dagger", Cost = 0},
		{Weapon = "WEAPON_KNUCKLE", Name = "Knuckle Dusters", Cost = 0},
		{Weapon = "WEAPON_HATCHET", Name = "Hatchet", Cost = 0},
		{Weapon = "WEAPON_MACHETE", Name = "Machete", Cost = 0},
		{Weapon = "WEAPON_SWITCHBLADE", Name = "Switchblade", Cost = 0},
		{Weapon = "WEAPON_BATTLEAXE", Name = "Battleaxe", Cost = 0},
		{Weapon = "WEAPON_POOLCUE", Name = "Poolcue", Cost = 0},
		{Weapon = "WEAPON_WRENCH", Name = "Wrench", Cost = 0},
	}},
	{Category = "Shotguns", Items = {
		{Weapon = "WEAPON_SAWNOFFSHOTGUN", Name = "Sawed-Off Shotgun", Cost = 0, AmmoType = "12g"},
		{Weapon = "WEAPON_DBSHOTGUN", Name = "Double Barrel Shotgun", Cost = 0, AmmoType = "12g"},
		{Weapon = "WEAPON_PUMPSHOTGUN", Name = "Pump Shotgun", Cost = 0, AmmoType = "12g"},
		{Weapon = "WEAPON_BULLPUPSHOTGUN", Name = "Bullpup Shotgun", Cost = 0, AmmoType = "11g"},
		{Weapon = "WEAPON_HEAVYSHOTGUN", Name = "Heavy Shotgun", Cost = 0, AmmoType = "12g"},
	}},
	{Category = "Illegal", Items = {
        ...
        {Name = "Ammo Box | 5.56mm", Id=86, Cost = 0, Max = 51},
        {Name = "Ammo Box | 7.62mm", Id=87, Cost = 0, Max = 51},
        {Name = "Ammo Box | .44mm", Id=88, Cost = 0, Max = 51},
        {Name = "Ammo Box | 12g", Id=89, Cost = 0, Max = 51},
        {Name = "Ammo Box | 11g", Id=90, Cost = 0, Max = 51},

    }},
	{Category = "Throwables", Items = {
		{Weapon = "WEAPON_MOLOTOV", Name = "Molotov", Cost = 0},
	}},
}
