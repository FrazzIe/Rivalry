...
Fishing = {
	Data = {
		Locations = {
			Service = {
				vector3(1333.0826416016,4325.9921875,38.052536010742), -- Galilee (Grapeseed)
			},
			Boat = {},
		},
		Pier = {
		...
		SellPoint = {
			...
			[2] = {Name = "Pompano", Id = 55, price = 25, Max = 100, sold = 0},
			[3] = {Name = "Snapper", Id = 56, price = 30, Max = 100, sold = 0},
			[4] = {Name = "Redfish", Id = 57, price = 40, Max = 100, sold = 0},
			[5] = {Name = "Bass", Id = 58, price = 50, Max = 100, sold = 0},
			[6] = {Name = "Mackerel", Id = 59, price = 75, Max = 100, sold = 0},
			[7] = {Name = "Herring", Id = 60, price = 80, Max = 100, sold = 0},
			[8] = {Name = "Salmon", Id = 61, price = 85, Max = 100, sold = 0},
			[9] = {Name = "Barracuda", Id = 62, price = 90, Max = 100, sold = 0},
			[10] = {Name = "Tuna", Id = 63, price = 95, Max = 100, sold = 0},
			[11] = {Name = "Yellowtail", Id = 64, price = 100, Max = 100, sold = 0},
		},
		Vehicles ={
			Model = "tug"
		},
